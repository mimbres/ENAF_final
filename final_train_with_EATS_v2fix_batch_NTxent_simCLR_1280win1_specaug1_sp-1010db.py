...
CUDA_VISIBLE_DEVICES=5 python final_train_with_EATS_v2fix_batch_NTxent_simCLR_1280win1_specaug1_sp-1010db.py final_exp_NTxent_simCLR_1280win1_specaug1_sp-1010db
CUDA_VISIBLE_DEVICES=5 python final_train_with_EATS_v2fix_batch_NTxent_simCLR_1280win1_specaug1_sp-1010db.py final_exp_NTxent_simCLR_1280win1_specaug1_sp-1010db '1' mini-test-only
CUDA_VISIBLE_DEVICES=5 python final_train_with_EATS_v2fix_batch_NTxent_simCLR_1280win1_specaug1_sp-1010db.py final_exp_NTxent_simCLR_1280win1_specaug1_sp-1010db '100' save-db-query 100k_full # 3:99.39
CUDA_VISIBLE_DEVICES=0 python eval_faiss.py gpu logs/emb/final_exp_NTxent_simCLR_1280win1_specaug1_sp-1010db/100/10k 2000 ivfpq-rr 20 mirex
...
CUDA_VISIBLE_DEVICES=5 OMP_NUM_THREADS=12 python eval_faiss.py gpu logs/emb/final_exp_NTxent_simCLR_1280win1_specaug1_sp-1010db/100/10k 2000 ivfpq-rr 20
matched_exact=[77.3  94.12 96.84 98.29 98.69 99.4 ]%, scope=[1, 3, 5, 9, 11, 19]
matched_near=[81.47 94.53 96.94 98.54 98.9  99.45]%, scope=[1, 3, 5, 9, 11, 19]
matched_song=[88.35 97.19 98.64 99.25 99.35 99.5 ]%, scope=[1, 3, 5, 9, 11, 19]

CUDA_VISIBLE_DEVICES=1 OMP_NUM_THREADS=12 python eval_faiss.py gpu logs/emb/final_exp_NTxent_simCLR_1280win1_specaug1_sp-1010db/100/100k_full 2000 ivfpq-rr 20
matched_exact=[58.26 79.71 85.23 90.86 92.21 94.98]%, scope=[1, 3, 5, 9, 11, 19]
matched_near=[60.72 80.56 85.79 91.11 92.52 95.28]%, scope=[1, 3, 5, 9, 11, 19]
matched_song=[71.87 86.64 90.06 93.87 94.88 96.53]%, scope=[1, 3, 5, 9, 11, 19]
