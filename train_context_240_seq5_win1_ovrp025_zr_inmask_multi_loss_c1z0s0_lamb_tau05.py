...
CUDA_VISIBLE_DEVICES=4 python train_context_240_seq5_win1_ovrp025_zr_inmask_multi_loss_c1z0s0_lamb_tau05.py exp_context_240_seq5_win1_ovrp025_zr_inmask_multi_loss_c1z0s0_lamb_tau05
CUDA_VISIBLE_DEVICES=4 python train_context_240_seq5_win1_ovrp025_zr_inmask_multi_loss_c1z0s0_lamb_tau05.py exp_context_240_seq5_win1_ovrp025_zr_inmask_multi_loss_c1z0s0_lamb_tau05 '' mini-test-only
CUDA_VISIBLE_DEVICES=4 python train_context_240_seq5_win1_ovrp025_zr_inmask_multi_loss_c1z0s0_lamb_tau05.py exp_context_240_seq5_win1_ovrp025_zr_inmask_multi_loss_c1z0s0_lamb_tau05 '45' save-db-query 100k # 3:99.39
...
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 23.68  48.89  65.60  82.33  87.27  96.91  
mrank: 40.23  13.10  6.15  1.56  0.70  0.08  
-----------ArgMin f(x) mini-TEST-----------
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 24.38  50.28  68.80  84.36  88.60  97.68  
mrank: 35.57  10.12  4.33  0.97  0.42  0.05  
---------ArgMin l2(f(x)) mini-TEST---------
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 24.24  50.42  68.66  84.36  88.53  97.61  
mrank: 35.54  10.19  4.42  0.99  0.43  0.05  
