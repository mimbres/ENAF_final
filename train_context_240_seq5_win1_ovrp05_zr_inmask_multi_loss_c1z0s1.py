...
CUDA_VISIBLE_DEVICES=5 python train_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z0s1.py exp_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z0s1
CUDA_VISIBLE_DEVICES=4 python train_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z0s1.py exp_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z0s1 '' mini-test-only
CUDA_VISIBLE_DEVICES=3 python train_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z0s1.py exp_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z0s1 '61' save-db-query 100k_full # 3:99.39

---------ArgMin g(f(x)) mini-TEST----------
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 78.19  93.39  96.10  98.74  99.23  100.00  
mrank: 4.80  0.83  0.24  0.02  0.01  0.00  
-----------ArgMin f(x) mini-TEST-----------
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 81.32  93.46  96.17  98.95  99.37  100.00  
mrank: 4.27  0.63  0.14  0.01  0.01  0.00  
---------ArgMin l2(f(x)) mini-TEST---------
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 81.32  93.53  96.17  98.95  99.37  100.00  
mrank: 4.26  0.63  0.14  0.01  0.01  0.00  

CUDA_VISIBLE_DEVICES=6 OMP_NUM_THREADS=12 python eval_faiss.py gpu logs/emb/exp_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z0s1/61/10k 2000 ivfpq-rr 20
matched_exact=[77.8  95.08 97.74 98.95 99.15 99.7 ]%, scope=[1, 3, 5, 9, 11, 19]
matched_near=[78.85 95.13 97.84 98.95 99.15 99.7 ]%, scope=[1, 3, 5, 9, 11, 19]
matched_song=[85.74 96.84 98.95 99.5  99.45 99.75]%, scope=[1, 3, 5, 9, 11, 19]

CUDA_VISIBLE_DEVICES=6 OMP_NUM_THREADS=12 python eval_faiss.py gpu logs/emb/exp_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z0s1/61/10k 2000 ivfpq-rr 20 mirex
matched_exact=[ 4.54  8.88 11.2  12.21 12.41 13.82]%, scope=[1, 3, 5, 9, 11, 19]
matched_near=[19.07 29.77 35.22 43.19 45.51 50.15]%, scope=[1, 3, 5, 9, 11, 19]
matched_song=[21.49 32.19 38.04 44.8  46.42 51.06]%, scope=[1, 3, 5, 9, 11, 19]

CUDA_VISIBLE_DEVICES=3 OMP_NUM_THREADS=12 python eval_faiss.py gpu logs/emb/exp_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z0s1/61/100k_full 2000 ivfpq-rr 20
matched_exact=[46.01 72.93 81.32 87.69 89.35 92.21]%, scope=[1, 3, 5, 9, 11, 19]
matched_near=[46.46 73.08 81.37 87.69 89.35 92.21]%, scope=[1, 3, 5, 9, 11, 19]
matched_song=[56.76 79.61 85.28 89.65 90.96 93.47]%, scope=[1, 3, 5, 9, 11, 19]
