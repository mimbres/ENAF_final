...
CUDA_VISIBLE_DEVICES=4 OMP_NUM_THREADS=12 python final_train_with_EATS_v2fix_batch_NTxent_simCLR_1280win1_specaug1_sp-1010db_lamb_tr100k.py final_exp_NTxent_simCLR_1280win1_specaug1_sp-1010db_lamb_tr100k
CUDA_VISIBLE_DEVICES=4 OMP_NUM_THREADS=12 python final_train_with_EATS_v2fix_batch_NTxent_simCLR_1280win1_specaug1_sp-1010db_lamb_tr100k.py final_exp_NTxent_simCLR_1280win1_specaug1_sp-1010db_lamb_tr100k '1' mini-test-only
CUDA_VISIBLE_DEVICES=4 OMP_NUM_THREADS=12 python final_train_with_EATS_v2fix_batch_NTxent_simCLR_1280win1_specaug1_sp-1010db_lamb_tr100k.py final_exp_NTxent_simCLR_1280win1_specaug1_sp-1010db_lamb_tr100k '63' save-db-query-all 
CUDA_VISIBLE_DEVICES=4 OMP_NUM_THREADS=12 python eval_faiss.py gpu logs/emb/final_exp_NTxent_simCLR_1280win1_specaug1_sp-1010db_lamb_tr100k/100/10k 2000 ivfpq-rr 20 mirex

task=10kMIREX, use_gpu=True, mode=ivfpq-rr, n_probe20, n_test1061
elapse time per 10 iterations: 0.2665 sec.
1060/1061
matched_exact=[ 9.43 14.8  16.02 18.38 18.57 21.21]%, scope=[1, 3, 5, 9, 11, 19]
matched_near=[35.82 52.78 61.26 73.42 75.12 82.66]%, scope=[1, 3, 5, 9, 11, 19]
matched_song=[35.82 52.78 61.26 73.42 75.12 82.66]%, scope=[1, 3, 5, 9, 11, 19]

task=10k, use_gpu=True, mode=ivfpq-rr, n_probe20, n_test2000
elapse time per 10 iterations: 0.2082 sec.
1999/2000
matched_exact=[84.8  96.25 97.7  99.   99.1  99.6 ]%, scope=[1, 3, 5, 9, 11, 19]
matched_near=[88.15 96.5  97.8  99.05 99.2  99.6 ]%, scope=[1, 3, 5, 9, 11, 19]
matched_song=[88.15 96.5  97.8  99.05 99.2  99.6 ]%, scope=[1, 3, 5, 9, 11, 19]

task=100k_full, use_gpu=True, mode=ivfpq-rr, n_probe20, n_test2000
elapse time per 10 iterations: 0.9410 sec.
1999/2000
matched_exact=[63.2  82.95 88.   92.95 93.6  95.65]%, scope=[1, 3, 5, 9, 11, 19]
matched_near=[65.75 83.45 88.3  93.   93.65 95.7 ]%, scope=[1, 3, 5, 9, 11, 19]
matched_song=[65.75 83.45 88.3  93.   93.65 95.7 ]%, scope=[1, 3, 5, 9, 11, 19]
...
def main():
    if TEST_MODE == 'mini-test-only':
        ...
        for ep in range(start_ep, MAX_EPOCH):
            ...
            enq.start(workers=12, max_queue_size=28)
