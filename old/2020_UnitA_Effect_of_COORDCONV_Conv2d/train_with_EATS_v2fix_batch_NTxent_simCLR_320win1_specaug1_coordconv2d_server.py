...
CUDA_VISIBLE_DEVICES=1 python train_with_EATS_v2fix_batch_NTxent_simCLR_320win1_specaug1_coordconv2d_server.py NTxent_simCLR_320win1_specaug1_coordconv2d
CUDA_VISIBLE_DEVICES=1 python train_with_EATS_v2fix_batch_NTxent_simCLR_320win1_specaug1_coordconv2d_server.py NTxent_simCLR_320win1_specaug1_coordconv2d '1' mini-test-only
CUDA_VISIBLE_DEVICES=1 python train_with_EATS_v2fix_batch_NTxent_simCLR_320win1_specaug1_coordconv2d_server.py NTxent_simCLR_320win1_specaug1_coordconv2d '100' save-db-query 100k_full # 3:99.39
...
m_fp = FingerPrinter(emb_sz=EMB_SZ, fc_unit_dim=[32, 1], norm=BN,
                     ...
                     front_hidden_ch=[256, 256, 256, 256, 512, 512, 1024, 1024], #[128, 128, 256, 256, 512, 512, 1024, 1024],
