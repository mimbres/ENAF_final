...
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_NTxent_simCLR_320win1_specaug1_conv2d_server.py NTxent_simCLR_320win1_specaug1_conv2d
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_NTxent_simCLR_320win1_specaug1_conv2d_server.py NTxent_simCLR_320win1_specaug1_conv2d '1' mini-test-only
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_NTxent_simCLR_320win1_specaug1_conv2d_server.py NTxent_simCLR_320win1_specaug1_conv2d '100' save-db-query 100k_full # 3:99.39
CUDA_VISIBLE_DEVICES=0 python eval.py logs/emb/exp_NTxent_simCLR_use_anc_rep_320/19 100
...
from model.nnfp_dm_2d import FingerPrinter
...
TR_BATCH_SZ = 320#320 #120#240 #320 #80  #40
TR_N_ANCHOR = 160#160 #60 #120 #64 #16  # 8
VAL_BATCH_SZ = 120
VAL_N_ANCHOR = 60
...
m_fp = FingerPrinter(emb_sz=EMB_SZ, fc_unit_dim=[32, 1], norm=BN,
                     use_L2layer=True, projection_layer_type='div_enc',
                     front_hidden_ch=[128, 128, 256, 256, 512, 512, 1024, 1024], #[128, 128, 256, 256, 512, 512, 1024, 1024],
                     add_coordconv=ADD_COORD_CONV)
...
def test_step(Xa, Xp, drop_div_enc=False):
    ...
    m_fp.trainable = False
    if drop_div_enc:
        #feat = m_fp.add_coord(feat) # fixed for coordconv case (09/10)
