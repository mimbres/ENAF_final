...
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_semihard_320win1_d64_tr100k_ts100kfull.py exp_v2fix_semihard_320win1_d64_tr100k '4' save-query
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_semihard_320win1_d64_tr100k_ts100kfull.py exp_v2fix_semihard_320win1_d64_tr100k '4' save-db
...
def generate_emb(n_query=2000000):
    ...
    """
    if n_query == 0: # gen DB
        GEN_EMB_BATCH_SZ = 128
        GEN_EMB_N_ANCHOR = GEN_EMB_BATCH_SZ
    else: # gen query
        GEN_EMB_BATCH_SZ = 60
        GEN_EMB_N_ANCHOR = 10
    ...
    gen_emb_ds = generator_fp.genUnbalSequence(
            ...
            shuffle=False,
            random_offset=False,
            bg_mix_parameter=[False], #[True, aug_ts_fps, TS_NOISE_DB],
