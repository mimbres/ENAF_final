...
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_semihard_320win1_d96.py exp_v2fix_semihard_320win1_d96
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_semihard_320win1_d96.py exp_v2fix_semihard_320win1_d96 '21' mini-test-only
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_semihard_320win1_d96.py exp_v2fix_semihard_320win1_d96 '21' save-db-query # 2:98.04
CUDA_VISIBLE_DEVICES=0 python eval.py logs/emb/exp_v2fix_semihard_320win1_d96/21 100
10dB minitest
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 71.35  97.17  99.43  100.00  100.00  100.00
mrank: 0.68  0.04  0.01  0.00  0.00  0.00
5dB
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 63.50  90.94  96.02  99.43  99.91  100.00  
mrank: 3.08  0.31  0.10  0.01  0.00  0.00  
0dB
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 43.53  77.00  86.10  91.46  93.46  96.91  
mrank: 19.61  4.29  1.96  0.62  0.41  0.07 
0dB noIR0
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 45.88  77.09  86.23  92.83  94.74  98.75
mrank: 15.34  2.97  1.25  0.34  0.21  0.01
...
test_ds = generator_fp.genUnbalSequence(
    ...
    shuffle=False,
    random_offset=True,
    bg_mix_parameter=[True, aug_ts_fps, (0,0)],
