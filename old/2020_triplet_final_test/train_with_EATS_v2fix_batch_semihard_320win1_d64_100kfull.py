...
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_semihard_320win1_d64_100kfull.py exp_v2fix_semihard_320win1_d64 '20' mini-test-only
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_semihard_320win1_d64_100kfull.py exp_v2fix_semihard_320win1_d64 '20' save-db-query 
CUDA_VISIBLE_DEVICES=0 python eval_faiss.py logs/emb/exp_v2fix_semihard_320win1_d64_100kfull/20
...
#%% test functions...
def generate_emb(n_query=110000):
    """
    Arguemnts:
