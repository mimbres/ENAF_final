...
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_semihard_320win1_d64_tr100k.py exp_v2fix_semihard_320win1_d64_tr100k 3
...
CUDA_VISIBLE_DEVICES=1 python train_with_EATS_v2fix_batch_semihard_320win1_d64_tr100k.py exp_v2fix_semihard_320win1_d64_tr100k '1' save-db-query 
CUDA_VISIBLE_DEVICES=1 python eval_faiss.py logs/emb/exp_v2fix_semihard_320win1_d64_tr100k_100k/4 2000 ivfpq-rr-ondisk 
...
TR_N_ANCHOR = 64 #16  # 8
VAL_BATCH_SZ = 320#320#160
VAL_N_ANCHOR = 64#160#32
TS_BATCH_SZ = 160
TS_N_ANCHOR = 32
GEN_EMB_BATCH_SZ = 240#320
GEN_EMB_N_ANCHOR = 40#120#160 # for 5 queries with different offsets
...
EMB_DIR = 'logs/emb/' + EXP_NAME + '_100k'
