...
CUDA_VISIBLE_DEVICES=1 python train_with_EATS_v2fix_batch_semihard_320win1_100kfull.py exp_v2fix_semihard_320win1 '20' mini-test-only
CUDA_VISIBLE_DEVICES=1 python train_with_EATS_v2fix_batch_semihard_320win1_100kfull.py exp_v2fix_semihard_320win1 '20' save-db-query 
CUDA_VISIBLE_DEVICES=1 python eval_faiss.py logs/emb/exp_v2fix_semihard_320win1_100kfull/20
