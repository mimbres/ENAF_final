...
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_semihard_320win1.py exp_v2fix_semihard_320win1re
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_semihard_320win1.py exp_v2fix_semihard_320win1re '19' mini-test-only
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_semihard_320win1.py exp_v2fix_semihard_320win1re '19' save-db-query # 3:99.39
CUDA_VISIBLE_DEVICES=0 python eval.py logs/emb/exp_v2fix_semihard_320win1re/19 100
