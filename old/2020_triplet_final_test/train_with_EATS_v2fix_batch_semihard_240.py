...
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_semihard_240.py exp_v2fix_semihard_240re
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_semihard_240.py exp_v2fix_semihard_240re '22' mini-test-only
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_semihard_240.py exp_v2fix_semihard_240re '22' save-db-query # 3:99.52
CUDA_VISIBLE_DEVICES=0 python eval.py logs/emb/exp_v2fix_semihard_240re/22 100
