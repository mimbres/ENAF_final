...
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_NTxent_simCLR_120win1_trtau.py exp_NTxent_simCLR_120_trtau
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_NTxent_simCLR_120win1.py exp_NTxent_simCLR_use_anc_rep_120 '1' mini-test-only
CUDA_VISIBLE_DEVICES=1 python train_with_EATS_v2fix_batch_NTxent_simCLR_120win1.py exp_NTxent_simCLR_use_anc_rep_120_tau0p05_ln_adam_ddrop_lr5e-5 '45' save-db-query 100k # 3:99.39
