...
CUDA_VISIBLE_DEVICES=1 python train_with_EATS_v2fix_batch_NTxent_simCLR_120win1_fixtau001.py exp_NTxent_simCLR_120_fixtau001
CUDA_VISIBLE_DEVICES=1 python train_with_EATS_v2fix_batch_NTxent_simCLR_120win1_fixtau001.py exp_NTxent_simCLR_120_fixtau001 '1' mini-test-only
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_NTxent_simCLR_120win1_fixtau001.py exp_NTxent_simCLR_120_fixtau001 '100' save-db-query 100k_full # 3:99.39
