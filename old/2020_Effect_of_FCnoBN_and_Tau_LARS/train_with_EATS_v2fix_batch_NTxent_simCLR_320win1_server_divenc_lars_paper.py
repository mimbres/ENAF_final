...
CUDA_VISIBLE_DEVICES=1 python train_with_EATS_v2fix_batch_NTxent_simCLR_320win1_server_divenc_lars_paper.py exp_NTxent_simCLR_320win1_server_divenc_lars_paper
CUDA_VISIBLE_DEVICES=1 python train_with_EATS_v2fix_batch_NTxent_simCLR_320win1_server_divenc_lars_paper.py exp_NTxent_simCLR_320win1_server_divenc_lars_paper '1' mini-test-only
CUDA_VISIBLE_DEVICES=1 python train_with_EATS_v2fix_batch_NTxent_simCLR_320win1_server_divenc_lars_paper.py exp_NTxent_simCLR_320win1_server_divenc_lars_paper '24' save-db-query # 3:99.39
python eval_faiss.py cpu logs/emb/exp_NTxent_simCLR_320win1_server_divenc_lars_paper/24/10k 2000 ivfpq-rr 20
