...
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_NTxent_simCLR_640win1_server_dm_noaug_tau005.py exp_NTxent_simCLR_640win1_server_dm_noaug_tau005
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_NTxent_simCLR_640win1_server_dm_noaug_tau005.py exp_NTxent_simCLR_640win1_server_dm_noaug_tau005 '1' mini-test-only
CUDA_VISIBLE_DEVICES=1 python train_with_EATS_v2fix_batch_NTxent_simCLR_640win1_server_dm_noaug_tau005.py exp_NTxent_simCLR_640win1_server_dm_noaug_tau005 '59' save-db-query # 3:99.39
CUDA_VISIBLE_DEVICES=1 python eval.py logs/emb/exp_NTxent_simCLR_640win1_server_dm_noaug_tau005/19 100
...
from model.online_NTxent_variant_loss_nnsoftmax import OnlineNTxentVariantLoss
...
# NTxent-parameters
TAU = 0.05 #0.05 # 0.1 #1. #0.3
REP_ORG_WEIGHTS = 1.0
LOSS_MODE = 'simCLR_use_anc_rep' #'simCLR_use_anc_rep_mod'  
SAVE_IMG = True
