...
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_NTxent_simCLR_320win1_server_fc_noBN_tau003.py exp_NTxent_simCLR_320win1_server_fc_noBN_tau003
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_NTxent_simCLR_320win1_server_fc_noBN_tau003.py exp_NTxent_simCLR_320win1_server_fc_noBN_tau003 '1' mini-test-only
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_NTxent_simCLR_320win1_server_fc_noBN_tau003.py exp_NTxent_simCLR_320win1_server_fc_noBN_tau003 '20' save-db-query 10k # 3:99.39
python eval_faiss.py cpu logs/emb/exp_NTxent_simCLR_320win1_server_fc_noBN_tau003/24/10k 2000 ivfpq-rr 20
...
m_fp = FingerPrinter(emb_sz=EMB_SZ, fc_unit_dim=[32, 1], norm=BN, projection_layer_type='fc_no_BN')
