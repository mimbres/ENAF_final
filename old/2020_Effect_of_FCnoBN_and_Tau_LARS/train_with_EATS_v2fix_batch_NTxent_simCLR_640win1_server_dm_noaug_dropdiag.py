...
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_NTxent_simCLR_640win1_server_dm_noaug_dropdiag.py exp_NTxent_simCLR_640win1_server_dm_noaug_dropdiag
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_NTxent_simCLR_640win1_server_dm_noaug.py exp_NTxent_simCLR_640win1_server_dm_noaug '1' mini-test-only
CUDA_VISIBLE_DEVICES=1 python train_with_EATS_v2fix_batch_NTxent_simCLR_640win1_server_dm_noaug.py exp_NTxent_simCLR_640win1_server_dm_noaug '59' save-db-query # 3:99.39
CUDA_VISIBLE_DEVICES=1 python eval.py logs/emb/exp_NTxent_simCLR_640win1_server_dm_noaug/19 100
...
TAU = 0.05 # 0.1 #1. #0.3
REP_ORG_WEIGHTS = 1.0
LOSS_MODE = 'simCLR_use_anc_rep_mod' #'simCLR_use_anc_rep' #'simCLR_use_anc_rep_mod'  
SAVE_IMG = True
