...
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_NTxent_simCLR_320win1_server_divenc_lars_tau005_cos.py exp_NTxent_simCLR_320win1_server_divenc_lars_tau005_cos
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_NTxent_simCLR_320win1_server_divenc_lars_tau005_cos.py exp_NTxent_simCLR_320win1_server_divenc_lars_tau005_cos '1' mini-test-only
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_NTxent_simCLR_320win1_server_divenc_lars_tau005_cos.py exp_NTxent_simCLR_320win1_server_divenc_lars_tau005_cos '24' save-db-query # 3:99.39
python eval_faiss.py cpu logs/emb/exp_NTxent_simCLR_320win1_server_divenc_lars_tau005_cos/24/10k 2000 ivfpq-rr 20
...
from model.lars_optimizer_mod import MomentumLARS
...
TAU = 0.05 # 0.1 #1. #0.3
REP_ORG_WEIGHTS = 1.0
LOSS_MODE = 'simCLR_use_anc_rep' # 
SAVE_IMG = False
BN = 'layer_norm2d' #'batch_norm'
OPTIMIZER = MomentumLARS # LAMB
LR = 0.375 #1e-4#5e-5#3e-5  #2e-5
LABEL_SMOOTH = 0
LR_SCHEDULE = 'cos'
...
TR_BATCH_SZ = 320 #120#240 #320 #80  #40
TR_N_ANCHOR = 160 #60 #120 #64 #16  # 8
VAL_BATCH_SZ = 120
VAL_N_ANCHOR = 60
...
m_fp = FingerPrinter(emb_sz=EMB_SZ, fc_unit_dim=[32, 1], norm=BN, projection_layer_type='div_enc')
...
def generate_emb(n_query=3000000):
    ...
    enq.start(workers=8, max_queue_size=12)
...
def main():
    if TEST_MODE == 'mini-test-only':
        ...
        for ep in range(start_ep, MAX_EPOCH):
            ...
            enq.start(workers=4, max_queue_size=8)
