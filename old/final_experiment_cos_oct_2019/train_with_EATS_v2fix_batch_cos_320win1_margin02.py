...
CUDA_VISIBLE_DEVICES=1 python train_with_EATS_v2fix_batch_cos_320win1_margin02.py exp_v2fix_cos_320win1_margin02
CUDA_VISIBLE_DEVICES=1 python train_with_EATS_v2fix_batch_cos_320win1_margin02.py exp_v2fix_cos_320win1_margin02 '' mini-test-only
CUDA_VISIBLE_DEVICES=1 python train_with_EATS_v2fix_batch_cos_320win1_margin02.py exp_v2fix_cos_320win1_margin02 '' save-db-query # 3:98.51
CUDA_VISIBLE_DEVICES=1 python eval.py logs/emb/exp_v2fix_cos_320win1_margin02/22 120 argmax

 skchang-vm-fp-preem-west1-a
7734/7734 [==============================] - 6156s 796ms/step - tr loss: 3.5766
trloss:3.5401, tsloss:3.1786
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 47.18  81.23  90.03  94.81  96.11  99.06
mrank: 13.41  4.29  1.91  0.58  0.35  0.01
EPOCH: 1/500
7734/7734 [==============================] - 6125s 792ms/step - tr loss: 3.5070
trloss:3.5006, tsloss:3.1529
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 52.78  85.06  93.36  98.55  99.16  100.00
mrank: 7.71  1.11  0.23  0.02  0.01  0.00
EPOCH: 2/500
7734/7734 [==============================] - 6302s 815ms/step - tr loss: 3.4878
trloss:3.4850, tsloss:3.1460
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 54.38  85.84  93.31  98.68  98.98  100.00
mrank: 7.68  1.05  0.27  0.02  0.01  0.00
EPOCH: 3/500
EPOCH: 5/500
7734/7734 [==============================] - 6250s 808ms/step - tr loss: 3.4677
trloss:3.4666, tsloss:3.1329
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 57.60  88.28  94.62  98.55  99.29  100.00
mrank: 6.70  0.89  0.24  0.03  0.01  0.00
EPOCH: 6/500
7734/7734 [==============================] - 6235s 806ms/step - tr loss: 3.4638
trloss:3.4632, tsloss:3.1312
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 57.81  88.41  94.93  98.37  99.16  100.00
mrank: 6.55  0.84  0.24  0.03  0.01  0.00
EPOCH: 7/500
7734/7734 [==============================] - 6243s 807ms/step - tr loss: 3.4612
trloss:3.4604, tsloss:3.1302
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 57.16  88.20  94.49  98.28  98.85  100.00
mrank: 6.37  0.78  0.24  0.03  0.02  0.00
...
Online_Triplet_Loss_tr = Online_Batch_Triplet_Loss(
    ...
    use_anc_as_pos=True)
loss_obj_tr = Online_Triplet_Loss_tr.batch_cos_loss
...
Online_Triplet_Loss_ts = Online_Batch_Triplet_Loss(
    ...
    use_anc_as_pos=True)
loss_obj_ts = Online_Triplet_Loss_ts.batch_cos_loss
