...
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_cos_240_margin03.py exp_v2fix_cos_240_margin03
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_cos_240_margin03.py exp_v2fix_cos_240_margin03 '10' mini-test-only
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_cos_240_margin03.py exp_v2fix_cos_240_margin03 '10' save-db-query # 3:98.51
CUDA_VISIBLE_DEVICES=0 python eval.py logs/emb/exp_v2fix_cos_240_margin03/22 100 argmax

5000/5000 [==============================] - 5691s 1s/step - tr loss: 3.4029
trloss:3.3579, tsloss:3.2570
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 51.09  83.14  91.56  97.27  98.10  99.42
mrank: 8.00  1.50  0.68  0.26  0.17  0.01
EPOCH: 1/500
5000/5000 [==============================] - 5518s 1s/step - tr loss: 3.3259
trloss:3.3200, tsloss:3.2354
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 52.26  85.45  93.66  98.20  98.94  99.69
mrank: 5.75  0.62  0.21  0.04  0.02  0.00
EPOCH: 2/500
5000/5000 [==============================] - 5439s 1s/step - tr loss: 3.3054
trloss:3.3025, tsloss:3.2242
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 55.08  88.07  95.10  98.72  99.16  99.87
mrank: 4.35  0.35  0.09  0.02  0.01  0.00
EPOCH: 3/500
5000/5000 [==============================] - 5300s 1s/step - tr loss: 3.2955
trloss:3.2935, tsloss:3.2170
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 56.25  88.28  95.72  98.86  99.38  99.96  
mrank: 3.85  0.30  0.08  0.02  0.01  0.00  
