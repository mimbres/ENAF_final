...
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_cosfix_320win1_margin02.py exp_v2fix_cosfix_320win1_margin02
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_cosfix_320win1_margin02.py exp_v2fix_cosfix_320win1_margin02 '' mini-test-only
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_cosfix_320win1_margin02.py exp_v2fix_cosfix_320win1_margin02 '' save-db-query # 3:98.51
CUDA_VISIBLE_DEVICES=0 python eval.py logs/emb/exp_v2fix_cosfix_320win1_margin02/22 120 argmax
...
Online_Triplet_Loss_tr = Online_Batch_Triplet_Loss(
    ...
    use_anc_as_pos=True)
loss_obj_tr = Online_Triplet_Loss_tr.batch_cos_loss_fix
...
Online_Triplet_Loss_ts = Online_Batch_Triplet_Loss(
    ...
    use_anc_as_pos=True)
loss_obj_ts = Online_Triplet_Loss_ts.batch_cos_loss_fix
