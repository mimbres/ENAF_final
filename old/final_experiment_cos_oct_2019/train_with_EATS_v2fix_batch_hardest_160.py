...
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_hardest_160.py exp_v2fix_hardest_160
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_hardest_160.py exp_v2fix_hardest_160 '14' mini-test-only
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_hardest_160.py exp_v2fix_hardest_160 '14' save-db-query # 0.26 @5
CUDA_VISIBLE_DEVICES=0 python eval.py logs/emb/exp_v2fix_hardest_160/14 100

top_1_acc = [0.00401606 0.00102451 0.         0.00109132 0.         0.        ]
...
# Hyper-parameters
LOSS_MODE = 'hardest'#'all-balanced'
