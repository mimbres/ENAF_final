...
CUDA_VISIBLE_DEVICES=1 python train_with_EATS_v2fix_batch_cos_240_margin1.py exp_v2fix_cos_240_margin1
CUDA_VISIBLE_DEVICES=1 python train_with_EATS_v2fix_batch_cos_240_margin1.py exp_v2fix_cos_240_margin1 '10' mini-test-only
CUDA_VISIBLE_DEVICES=1 python train_with_EATS_v2fix_batch_cos_240_margin1.py exp_v2fix_cos_240_margin1 '10' save-db-query # 3:98.51
CUDA_VISIBLE_DEVICES=1 python eval.py logs/emb/exp_v2fix_cos_240_margin1/22 100 argmax

5000/5000 [==============================] - 5707s 1s/step - tr loss: 4.0974
trloss:4.0447, tsloss:3.9383
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 51.65  83.28  93.09  97.49  98.37  100.00
mrank: 7.70  1.13  0.38  0.09  0.04  0.00
EPOCH: 1/500
5000/5000 [==============================] - 5470s 1s/step - tr loss: 4.0107
trloss:4.0045, tsloss:3.9182
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 52.91  83.93  93.79  98.46  99.16  99.87
mrank: 6.24  0.77  0.25  0.04  0.02  0.00
EPOCH: 2/500
5000/5000 [==============================] - 5412s 1s/step - tr loss: 3.9892
trloss:3.9854, tsloss:3.9055
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 54.56  86.89  95.02  98.72  99.51  100.00
mrank: 4.70  0.50  0.10  0.02  0.01  0.00
EPOCH: 3/500
5000/5000 [==============================] - 5296s 1s/step - tr loss: 3.9777
trloss:3.9754, tsloss:3.8999
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 55.69  87.50  94.89  98.81  99.51  100.00
mrank: 4.12  0.41  0.09  0.01  0.00  0.00
