...
SHUFFLE_BUFFER_SZ = 2000 #tf.data.experimental.AUTOTUNE # 2000
...
N_POS_SEG_FROM_SLICE = 7 # almost fixed..
SEG_DUR_IN_SEC =  1.# 1(default) or 2 s
SLICE_HOP_IN_SEC = 0.5#0.5
...
def build_dataset(fps=list(),
    ...
    SLICE_HOP = closest_pow2(round(SR * SLICE_HOP_IN_SEC)) # 0.512 s; 4096
