...
USAGE:
    CUDA_VISIBLE_DEVICES=0 python train_batch_all.py <option:EXP_NAME>
...
LR = 1e-5 
BATCH_SZ = 84 #350 #70 # Preferred to be devidable with 7
BATCH_HARD = False # If True:batch_hard_triple_loss; Else:batch_all_triplet_loss 
TRIPLET_MARGIN = 0.5
EPOCHS = 500
TEST_SPLIT = 0.1
SHUFFLE_BUFFER_SZ = 2000
