...
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_NTxent_simCLR_120win1_eff.py exp_NTxent_simCLR_use_anc_rep_120_eff2
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_NTxent_simCLR_120win1_eff.py exp_NTxent_simCLR_use_anc_rep_120 '1' mini-test-only
CUDA_VISIBLE_DEVICES=1 python train_with_EATS_v2fix_batch_NTxent_simCLR_120win1_eff.py exp_NTxent_simCLR_use_anc_rep_120 '19' save-db-query # 3:99.39
...
LR = 1e-5 #1e-4#3e-5  #2e-5
LABEL_SMOOTH = 0
LR_SCHEDULE = ''
USE_EFFNET_VER = 2 # False
