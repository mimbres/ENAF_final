...
CUDA_VISIBLE_DEVICES=2 python train_with_EATS_v2fix_batch_NTxent_simCLR_120win1_WS_10dbNOIR.py exp_NTxent_simCLR_use_anc_rep_120win1_WS_10dbNOIR
CUDA_VISIBLE_DEVICES=2 python train_with_EATS_v2fix_batch_NTxent_simCLR_120win1_WS_10dbNOIR.py exp_NTxent_simCLR_use_anc_rep_120win1_WS_10dbNOIR '1' mini-test-only
CUDA_VISIBLE_DEVICES=2 python train_with_EATS_v2fix_batch_NTxent_simCLR_120win1_WS_10dbNOIR.py exp_NTxent_simCLR_use_anc_rep_120win1_WS_10dbNOIR '36' save-db-query 10k # 3:99.39
...
VAL_BATCH_SZ = 120
VAL_N_ANCHOR = 60
TS_BATCH_SZ = 160 #320 #160 #160
TS_N_ANCHOR = 32 #160 #32 #80
MAX_EPOCH = 50
EPOCH = ''
TEST_MODE = ''
...
def get_train_ds():
    ds = generator_fp.genUnbalSequence(
        ...
        shuffle=True,
        random_offset=True,
        bg_mix_parameter=[True, aug_tr_fps, AUG_BG_RANGE],
        ir_mix_parameter=[AUG_IR, ir_fps])
    return ds
