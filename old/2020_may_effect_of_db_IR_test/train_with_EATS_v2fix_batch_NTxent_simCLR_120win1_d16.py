...
CUDA_VISIBLE_DEVICES=1 python train_with_EATS_v2fix_batch_NTxent_simCLR_120win1_d16.py exp_NTxent_simCLR_use_anc_rep_120_d16
CUDA_VISIBLE_DEVICES=1 python train_with_EATS_v2fix_batch_NTxent_simCLR_120win1_d16.py exp_NTxent_simCLR_use_anc_rep_120_d16 '15' mini-test-only
CUDA_VISIBLE_DEVICES=1 python train_with_EATS_v2fix_batch_NTxent_simCLR_120win1_d16.py exp_NTxent_simCLR_use_anc_rep_120_d16 '15' save-db-query 100k # 3:99.39
...
def generate_emb(n_query=3000000):
    ...
    enq.start(workers=12, max_queue_size=20)
