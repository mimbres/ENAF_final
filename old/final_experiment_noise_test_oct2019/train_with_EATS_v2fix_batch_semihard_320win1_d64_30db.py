...
CUDA_VISIBLE_DEVICES=1 python train_with_EATS_v2fix_batch_semihard_320win1_d64_30db.py exp_v2fix_semihard_320win1_d64_30db
CUDA_VISIBLE_DEVICES=1 python train_with_EATS_v2fix_batch_semihard_320win1_d64_30db.py exp_v2fix_semihard_320win1_d64_30db '' mini-test-only
CUDA_VISIBLE_DEVICES=1 python train_with_EATS_v2fix_batch_semihard_320win1_d64_30db.py exp_v2fix_semihard_320win1_d64_30db '' save-db-query # 3:96.69
CUDA_VISIBLE_DEVICES=1 python eval.py logs/emb/exp_v2fix_semihard_320win1_d64_30db/20 100

20db
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 76.65  98.61  99.87  100.00  100.00  100.00
mrank: 0.38  0.01  0.00  0.00  0.00  0.00
noIR
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 78.26  99.30  99.96  100.00  100.00  100.00  
mrank: 0.31  0.01  0.00  0.00  0.00  0.00 

10db
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 67.10  93.68  97.55  99.65  99.82  100.00  
mrank: 2.89  0.20  0.07  0.01  0.00  0.00  
noIR
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 68.58  94.29  97.55  99.69  99.96  100.00  
mrank: 2.34  0.19  0.06  0.01  0.00  0.00  

5db
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 52.91  84.19  91.26  95.33  96.33  99.01  
mrank: 12.37  1.74  0.51  0.15  0.12  0.02 
noIR
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 54.86  85.10  91.96  95.51  96.25  98.66
mrank: 10.64  1.48  0.51  0.15  0.11  0.02 

0db
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 32.73  66.16  80.07  88.95  91.03  94.44  
mrank: 40.29  13.36  6.08  1.86  1.26  0.43 
noIR
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 33.68  66.38  80.86  89.57  91.83  95.07  
mrank: 36.83  11.51  5.32  1.72  1.20  0.39 
