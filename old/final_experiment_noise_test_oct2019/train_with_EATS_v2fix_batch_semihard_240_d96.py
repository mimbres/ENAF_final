...
CUDA_VISIBLE_DEVICES=1 python train_with_EATS_v2fix_batch_semihard_240_d96.py exp_v2fix_semihard_240_d96re
CUDA_VISIBLE_DEVICES=1 python train_with_EATS_v2fix_batch_semihard_240_d96.py exp_v2fix_semihard_240_d96re '20' mini-test-only
CUDA_VISIBLE_DEVICES=1 python train_with_EATS_v2fix_batch_semihard_240_d96.py exp_v2fix_semihard_240_d96re '20' save-db-query #3:
CUDA_VISIBLE_DEVICES=1 python eval.py logs/emb/exp_v2fix_semihard_240_d96re/20 100

 1: 74.0833 - 3: 97.2277 - 5: 98.9855 - 9: 99.6693 - 11: 99.8070 - 19: 99.9633
