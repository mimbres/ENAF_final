...
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_semihard_320win1_d64_nodiv.py exp_v2fix_semihard_320win1_d64_nodiv
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_semihard_320win1_d64_nodiv.py exp_v2fix_semihard_320win1_d64_nodiv '' mini-test-only
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_semihard_320win1_d64_nodiv.py exp_v2fix_semihard_320win1_d64_nodiv '' save-db-query # 3:96.69
CUDA_VISIBLE_DEVICES=0 python eval.py logs/emb/exp_v2fix_semihard_320win1_d64_nodiv/20 100


10dB with div (for reference)
scope:   [1, 3, 5, 9, 11, 19]
...
from model.nnfp_l2norm_v2_fixed_nodiv import FingerPrinter
