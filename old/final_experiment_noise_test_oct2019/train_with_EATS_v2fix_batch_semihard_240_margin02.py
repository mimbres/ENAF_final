...
CUDA_VISIBLE_DEVICES=1 python train_with_EATS_v2fix_batch_semihard_240_margin02.py exp_v2fix_semihard_240_margin02
CUDA_VISIBLE_DEVICES=1 python train_with_EATS_v2fix_batch_semihard_240_margin02.py exp_v2fix_semihard_240_margin02 '' mini-test-only
CUDA_VISIBLE_DEVICES=1 python train_with_EATS_v2fix_batch_semihard_240_margin02.py exp_v2fix_semihard_240_margin02 '11' save-db-query # 3:97.65
CUDA_VISIBLE_DEVICES=1 python eval.py logs/emb/exp_v2fix_semihard_240_margin02/11 100

 1: 72.1355 - 3: 96.9890 - 5: 98.9332 - 9: 99.6388 - 11: 99.7535 - 19: 99.9682
...
#%%
#EXP_NAME = 'exp_v2fix_semihard_240_margin02'
#EPOCH = ''
TEST_MODE = 'mini-test'
