...
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_semihard_320win1_d64_5db.py exp_v2fix_semihard_320win1_d64_5db
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_semihard_320win1_d64_5db.py exp_v2fix_semihard_320win1_d64_5db '10' mini-test-only
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_semihard_320win1_d64_5db.py exp_v2fix_semihard_320win1_d64_5db '10' save-db-query # 3:96.69
CUDA_VISIBLE_DEVICES=0 python eval.py logs/emb/exp_v2fix_semihard_320win1_d64_5db/20 100
preem-b

20db
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 73.87  97.87  99.69  100.00  100.00  100.00
mrank: 0.48  0.02  0.00  0.00  0.00  0.00
noIR
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 77.82  98.91  99.74  100.00  100.00  100.00  
mrank: 0.31  0.01  0.00  0.00  0.00  0.00 

10db
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 69.84  96.04  99.21  100.00  100.00  100.00  
mrank: 1.17  0.08  0.01  0.00  0.00  0.00
noIR  
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 72.01  95.21  98.16  99.69  99.91  100.00  
mrank: 1.05  0.10  0.03  0.00  0.00  0.00 

5db
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 59.33  89.72  95.98  99.08  99.60  100.00  
mrank: 5.49  0.52  0.12  0.01  0.00  0.00  
noIR
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 61.07  87.85  93.49  96.96  97.57  99.91  
mrank: 4.99  0.84  0.35  0.09  0.05  0.00 

0db
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 39.54  72.13  83.70  91.90  93.37  96.15  
mrank: 24.63  5.58  2.33  0.77  0.51  0.10 
noIR
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 37.59  70.17  81.86  90.10  92.09  95.39  
mrank: 22.39  5.83  2.83  1.00  0.66  0.14 
