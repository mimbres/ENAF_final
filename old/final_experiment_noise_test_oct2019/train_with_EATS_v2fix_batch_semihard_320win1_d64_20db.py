...
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_semihard_320win1_d64_20db.py exp_v2fix_semihard_320win1_d64_20db
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_semihard_320win1_d64_20db.py exp_v2fix_semihard_320win1_d64_20db '' mini-test-only
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_semihard_320win1_d64_20db.py exp_v2fix_semihard_320win1_d64_20db '' save-db-query # 3:96.69
CUDA_VISIBLE_DEVICES=0 python eval.py logs/emb/exp_v2fix_semihard_320win1_d64_20db/20 100
preem-b
20db
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 76.30  98.17  99.83  100.00  100.00  100.00  
mrank: 0.46  0.02  0.00  0.00  0.00  0.00
noIR
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 78.47  99.30  99.96  100.00  100.00  100.00  
mrank: 0.29  0.01  0.00  0.00  0.00  0.00 

10db
trloss:0.0009, tsloss:0.0951
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 68.75  93.86  98.51  99.96  100.00  100.00  
mrank: 2.95  0.25  0.03  0.00  0.00  0.00  
noIR
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 70.23  95.25  98.60  99.78  99.91  100.00  
mrank: 2.36  0.16  0.03  0.00  0.00  0.00 

5db
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 53.60  85.50  91.56  96.21  97.26  99.60  
mrank: 11.86  2.44  0.83  0.13  0.08  0.00 
noIR
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 55.43  86.54  92.79  96.96  98.01  99.96  
mrank: 10.14  1.68  0.54  0.09  0.05  0.00 

0db
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 31.21  63.33  79.46  89.39  91.08  94.71  
mrank: 38.49  14.29  8.03  3.36  2.66  0.86 
noIR
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 32.55  64.63  80.07  89.88  91.96  95.12  
mrank: 34.58  11.77  6.21  2.51  1.99  0.71
