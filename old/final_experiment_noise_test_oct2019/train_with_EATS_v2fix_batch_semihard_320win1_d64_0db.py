...
CUDA_VISIBLE_DEVICES=1 python train_with_EATS_v2fix_batch_semihard_320win1_d64_0db.py exp_v2fix_semihard_320win1_d64_0db
CUDA_VISIBLE_DEVICES=1 python train_with_EATS_v2fix_batch_semihard_320win1_d64_0db.py exp_v2fix_semihard_320win1_d64_0db '7' mini-test-only
CUDA_VISIBLE_DEVICES=1 python train_with_EATS_v2fix_batch_semihard_320win1_d64_0db.py exp_v2fix_semihard_320win1_d64_0db '7' save-db-query # 3:96.69
CUDA_VISIBLE_DEVICES=1 python eval.py logs/emb/exp_v2fix_semihard_320win1_d64_0db/20 100

20db
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 71.44  96.86  99.65  99.96  100.00  100.00  
mrank: 0.58  0.03  0.00  0.00  0.00  0.00
noIR
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 77.86  98.82  99.87  100.00  100.00  100.00  
mrank: 0.32  0.01  0.00  0.00  0.00  0.00 

10db
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 66.88  94.73  98.30  100.00  100.00  100.00
mrank: 1.85  0.11  0.02  0.00  0.00  0.00
noIR
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 70.01  95.47  98.34  99.91  100.00  100.00  
mrank: 1.18  0.07  0.02  0.00  0.00  0.00 

5db
scope:   [1, 3, 5, 9, 11, 19]                                                                                      
T1acc: 56.38  88.37  93.66  98.42  99.25  100.00                                                                   
mrank: 7.97  0.87  0.24  0.02  0.01  0.00  
noIR
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 58.12  87.41  93.79  98.24  99.38  100.00  
mrank: 5.08  0.70  0.23  0.02  0.01  0.00  

0db
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 39.37  73.82  84.57  91.46  93.46  97.04  
mrank: 24.86  5.84  2.54  0.67  0.41  0.07  
noIR
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 36.37  66.59  78.15  90.71  93.51  97.04  
mrank: 23.33  5.97  2.61  0.63  0.36  0.10 
