...
CUDA_VISIBLE_DEVICES=1 python train_with_EATS_v2fix_batch_semihard_240_d256.py exp_v2fix_semihard_240_d256re
CUDA_VISIBLE_DEVICES=1 python train_with_EATS_v2fix_batch_semihard_240_d256.py exp_v2fix_semihard_240_d256re '20' mini-test-only
CUDA_VISIBLE_DEVICES=1 python train_with_EATS_v2fix_batch_semihard_240_d256.py exp_v2fix_semihard_240_d256re '20' save-db-query # 3:99.52
CUDA_VISIBLE_DEVICES=1 python eval.py logs/emb/exp_v2fix_semihard_240_d256re/20 100
...
#%%
#EXP_NAME = 'exp_v2fix_semihard_240_d256'
#EPOCH = ''
TEST_MODE = 'mini-test'
