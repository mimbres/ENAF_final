...
CUDA_VISIBLE_DEVICES=1 python train_with_EATS_v2fix_batch_NTxent_simCLR_640win1_server_d32.py exp_NTxent_simCLR_640_ln_drop_lamb_d32
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_NTxent_simCLR_640win1_server_d32.py exp_NTxent_simCLR_640_ln_drop_lamb_d32 '12' mini-test-only
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_NTxent_simCLR_640win1_server_d32.py exp_NTxent_simCLR_640_ln_drop_lamb_d32 '12' save-db-query 100k
CUDA_VISIBLE_DEVICES=1 python eval.py logs/emb/exp_NTxent_simCLR_use_anc_rep_320/19 100

CUDA_VISIBLE_DEVICES=1 python train_with_EATS_v2fix_batch_NTxent_simCLR_120win1_d32.py exp_NTxent_simCLR_use_anc_rep_120_d32 '36' mini-test-only
CUDA_VISIBLE_DEVICES=1 python train_with_EATS_v2fix_batch_NTxent_simCLR_120win1_d32.py exp_NTxent_simCLR_use_anc_rep_120_d32 '36' save-db-query 100k
@author: skchang@cochlear.ai
"""
#%%
