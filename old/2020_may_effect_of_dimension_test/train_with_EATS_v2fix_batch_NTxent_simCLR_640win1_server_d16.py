...
CUDA_VISIBLE_DEVICES=1 python train_with_EATS_v2fix_batch_NTxent_simCLR_640win1_server_d16.py exp_NTxent_simCLR_640_ln_drop_lamb_d16
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_NTxent_simCLR_640win1_server_d16.py exp_NTxent_simCLR_640_ln_drop_lamb_d16 '49' mini-test-only
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_NTxent_simCLR_640win1_server_d16.py exp_NTxent_simCLR_640_ln_drop_lamb_d16 '49' save-db-query 100k_full
...
OPTIMIZER = LAMB
LR = 1e-4#1e-4#1e-4#5e-5#3e-5  #2e-5
LABEL_SMOOTH = 0
LR_SCHEDULE = ''
