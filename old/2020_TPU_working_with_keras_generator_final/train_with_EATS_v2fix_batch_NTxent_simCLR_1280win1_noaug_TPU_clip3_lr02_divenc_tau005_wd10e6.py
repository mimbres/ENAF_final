...
python3 train_with_EATS_v2fix_batch_NTxent_simCLR_1280win1_noaug_TPU_clip3_lr02_divenc_tau005_wd10e6.py exp_NTxent_simCLR_1280_noaug_TPU_clip3_lr02_divenc_tau005w_d10e6
python3 train_with_EATS_v2fix_batch_NTxent_simCLR_1280win1_noaug_TPU_clip3_lr02_divenc_tau005wd10e6.py exp_NTxent_simCLR_1280_noaug_TPU_clip3_lr02_divenc_tau005_wd10e6 '' mini-test-only
CUDA_VISIBLE_DEVICES=2 python train_with_EATS_v2fix_batch_NTxent_simCLR_320win1_server_fc_noBN_tau005.py exp_NTxent_simCLR_1280_noaug_TPU_clip3_lr02_divenc_tau005w_d10e6 '21' save-db-query 10k 
...
with strategy.scope():
    if LR_SCHEDULE == 'cos':
        ...
        opt = OPTIMIZER(learning_rate=LR, weight_decay_rate=1e-5)
