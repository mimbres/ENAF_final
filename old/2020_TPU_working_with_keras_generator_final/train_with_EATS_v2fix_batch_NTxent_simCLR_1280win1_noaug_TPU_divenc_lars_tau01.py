...
python3 train_with_EATS_v2fix_batch_NTxent_simCLR_1280win1_noaug_TPU_divenc_lars_tau01.py exp_NTxent_simCLR_1280_noaug_TPU_divenc_lars_tau01
python3 train_with_EATS_v2fix_batch_NTxent_simCLR_1280win1_noaug_TPU_divenc_lars_tau01.py exp_NTxent_simCLR_1280_noaug_TPU_divenc_lars_tau01 '' mini-test-only
CUDA_VISIBLE_DEVICES=0 train_with_EATS_v2fix_batch_NTxent_simCLR_1280win1_noaug_TPU_divenc_lars_tau01.py exp_NTxent_simCLR_1280_noaug_TPU_divenc_lars_tau01 '' save-db-query 100k 
python eval_faiss.py cpu logs/emb/exp_NTxent_simCLR_1280_noaug_TPU_divenc_lars_tau01/61/100k 2000 ivfpq-rr 20
...
# TPU setup
USE_TPU = True
TPU_NAME = 'skchang-tpu-fp-v3-8e'
N_REPLICAS = 8 # 1) num of replicas = num of cores, 2) batch_sz should be dividable with num of replicas  
GS_STORAGE_PREFIX = f'gs://skchang_dlfp_eu/{TPU_NAME}' #'gs://dlfp-tpu-europe-west4'
...
OPTIMIZER = MomentumLARS #LAMB #tfa.optimizers.LAMB # tf.keras.optimizers.Adam # LAMB
LR = 3.5 #2e-4#1e-4#5e-5#3e-5  #2e-5 #1.5 nono
LABEL_SMOOTH = 0
LR_SCHEDULE = 'cos'
#GRAD_CLIP_NORM = 3.
...
with strategy.scope():
    ...
    m_fp = FingerPrinter(emb_sz=EMB_SZ, fc_unit_dim=[32, 1], norm=BN, use_L2layer=True, projection_layer_type='div_enc')
...
def main():
    if TEST_MODE == 'mini-test-only':
        ...
        for ep in range(start_ep, MAX_EPOCH):
            ...
            enq.start(workers=31, max_queue_size=40)
