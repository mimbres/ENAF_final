...
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_NTxent_simCLR_640win1_specaug065_3c2s_server.py exp_NTxent_simCLR_640_specaug065_3c2s
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_NTxent_simCLR_640win1_specaug065_3c2s_server.py exp_NTxent_simCLR_640_specaug065_3c2s '1' mini-test-only
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_NTxent_simCLR_640win1_specaug065_3c2s_server.py exp_NTxent_simCLR_640_specaug065_3c2s '100' save-db-query 100k_full # 3:99.39
CUDA_VISIBLE_DEVICES=0 python eval.py logs/emb/exp_NTxent_simCLR_640_specaug08_3c2s/19 100
...
# Specaug parameters
SPECAUG_CHAIN = ['cutout', 'horizontal', 'vertical']
SPECAUG_PROBS = 0.65
SPECAUG_N_HOLES = 3
