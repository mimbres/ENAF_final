...
CUDA_VISIBLE_DEVICES=2 python train_with_EATS_v2fix_batch_NTxent_simCLR_120win1.py exp_NTxent_simCLR_120_fixtau001
CUDA_VISIBLE_DEVICES=2 python train_with_EATS_v2fix_batch_NTxent_simCLR_120win1.py exp_NTxent_simCLR_120_fixtau001 '1' mini-test-only
CUDA_VISIBLE_DEVICES=2 python train_with_EATS_v2fix_batch_NTxent_simCLR_120win1.py exp_NTxent_simCLR_120_fixtau001 '45' save-db-query 100k # 3:99.39
