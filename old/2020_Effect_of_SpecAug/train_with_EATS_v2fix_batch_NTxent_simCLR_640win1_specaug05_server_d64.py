...
CUDA_VISIBLE_DEVICES=1 python train_with_EATS_v2fix_batch_NTxent_simCLR_640win1_specaug05_server_d64.py exp_NTxent_simCLR_640_specaug05_d64
CUDA_VISIBLE_DEVICES=1 python train_with_EATS_v2fix_batch_NTxent_simCLR_640win1_specaug05_server_d64.py exp_NTxent_simCLR_640_specaug05_d64 '61' mini-test-only
CUDA_VISIBLE_DEVICES=1 python train_with_EATS_v2fix_batch_NTxent_simCLR_640win1_specaug05_server_d64.py exp_NTxent_simCLR_640_specaug05_d64 '100' save-db-query 10k # 3:94.16
python eval_faiss.py cpu logs/emb/exp_NTxent_simCLR_640_specaug05/61/100k 2000 ivfpq-rr 20
