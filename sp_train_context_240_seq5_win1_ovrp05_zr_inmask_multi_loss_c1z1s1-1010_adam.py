...
CUDA_VISIBLE_DEVICES=6 python sp_train_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z1s1-1010_adam.py exp_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z1s1-1010_adam
CUDA_VISIBLE_DEVICES=4 python sp_train_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z1s1-1010_adam.py exp_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z1s1-1010_adam '' mini-test-only

---------ArgMin g(f(x)) mini-TEST----------
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 73.26  90.13  94.22  97.28  97.97  99.44  
mrank: 10.76  1.99  0.41  0.06  0.03  0.01  
-----------ArgMin f(x) mini-TEST-----------
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 77.99  92.49  95.61  98.18  98.39  99.58  
mrank: 6.96  0.67  0.09  0.03  0.02  0.00  
---------ArgMin l2(f(x)) mini-TEST---------
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 78.12  92.49  95.61  98.11  98.39  99.58  
mrank: 6.78  0.60  0.09  0.03  0.02  0.00  

CUDA_VISIBLE_DEVICES=6 OMP_NUM_THREADS=12 python eval_faiss.py gpu logs/emb/exp_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z1s1-1010_adam/10k 2000 ivfpq-rr 20 mirex
matched_exact=[ 8.38 15.84 18.37 20.08 20.69 21.9 ]%, scope=[1, 3, 5, 9, 11, 19]
matched_near=[31.38 54.29 64.08 74.87 77.19 81.53]%, scope=[1, 3, 5, 9, 11, 19]
matched_song=[33.2  55.9  65.39 75.88 78.3  82.85]%, scope=[1, 3, 5, 9, 11, 19]

CUDA_VISIBLE_DEVICES=1 OMP_NUM_THREADS=12 python eval_faiss.py gpu logs/emb/exp_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z1s1-1010_adam/10k 2000 ivfpq-rr 20
matched_exact=[81.97 96.74 98.79 99.45 99.55 99.8 ]%, scope=[1, 3, 5, 9, 11, 19]
matched_near=[82.37 96.79 98.84 99.45 99.55 99.8 ]%, scope=[1, 3, 5, 9, 11, 19]
matched_song=[90.01 98.74 99.6  99.75 99.85 99.85]%, scope=[1, 3, 5, 9, 11, 19]

CUDA_VISIBLE_DEVICES=3 OMP_NUM_THREADS=12 python eval_faiss.py gpu logs/emb/exp_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z1s1-1010_adam/100/100k_full 2000 ivfpq-rr 20
matched_exact=[34.46 68.41 77.25 83.83 84.83 88.85]%, scope=[1, 3, 5, 9, 11, 19]
matched_near=[34.51 68.46 77.35 83.88 84.88 88.85]%, scope=[1, 3, 5, 9, 11, 19]
matched_song=[43.7  75.09 82.32 87.24 87.85 90.41]%, scope=[1, 3, 5, 9, 11, 19]

--Search with transformer--
CUDA_VISIBLE_DEVICES=2 OMP_NUM_THREADS=12 python sp_train_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z1s1-1010_adam.py exp_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z1s1-1010_adam '100' test_sc3
...
def main():
    if TEST_MODE == 'mini-test-only':
        ...
        m_fp.trainable = False
        emb_dir = 'logs/emb/exp_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z1s1-1010_adam/10k'
        ...
        emb_dir = 'logs/emb/exp_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z1s1-1010_adam/100/100k_full'
        eval(use_gpu=True, emb_dir=emb_dir, n_sample_test=2000, mode='ivfpq-rr',
             n_probe = 20, display_interval=10, test_mirex_query=False,
             scope=[3], transformer=m_fp) # 10k mirex test
        eval(use_gpu=True, emb_dir=emb_dir, n_sample_test=2000, mode='ivfpq-rr',
