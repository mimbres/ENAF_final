...
CUDA_VISIBLE_DEVICES=4 python sp_train_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z0s1-1010_adam.py exp_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z0s1-1010_adam
CUDA_VISIBLE_DEVICES=4 OMP_NUM_THREADS=12 python eval_faiss.py gpu logs/emb/exp_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z0s1-1010_adam/10k 2000 ivfpq-rr 20 mirex
matched_exact=[ 9.89 16.65 18.26 20.08 20.59 22.  ]%, scope=[1, 3, 5, 9, 11, 19]
matched_near=[35.82 54.39 64.28 74.77 77.4  82.54]%, scope=[1, 3, 5, 9, 11, 19]
matched_song=[37.84 56.31 66.09 75.98 78.71 83.65]%, scope=[1, 3, 5, 9, 11, 19]

CUDA_VISIBLE_DEVICES=0 OMP_NUM_THREADS=12 python eval_faiss.py gpu logs/emb/exp_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z0s1-1010_adam/10k 2000 ivfpq-rr 20
matched_exact=[82.32 96.48 98.14 99.2  99.45 99.8 ]%, scope=[1, 3, 5, 9, 11, 19]
matched_near=[82.82 96.53 98.24 99.2  99.45 99.8 ]%, scope=[1, 3, 5, 9, 11, 19]
matched_song=[90.21 98.04 99.15 99.6  99.6  99.85]%, scope=[1, 3, 5, 9, 11, 19]

CUDA_VISIBLE_DEVICES=2 OMP_NUM_THREADS=12 python eval_faiss.py gpu logs/emb/exp_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z0s1-1010_adam/100/100k_full 2000 ivfpq-rr 20
matched_exact=[37.07 65.85 75.14 83.07 84.58 88.6 ]%, scope=[1, 3, 5, 9, 11, 19]
matched_near=[37.22 65.85 75.14 83.07 84.58 88.6 ]%, scope=[1, 3, 5, 9, 11, 19]
matched_song=[47.11 73.23 80.61 86.24 87.64 90.46]%, scope=[1, 3, 5, 9, 11, 19]

--Search with transformer--
CUDA_VISIBLE_DEVICES=0 OMP_NUM_THREADS=12 python sp_train_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z0s1-1010_adam.py exp_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z0s1-1010_adam '100' test_sc3
...
def main():
    if TEST_MODE == 'mini-test-only':
        ...
        m_fp.trainable = False
        emb_dir = 'logs/emb/exp_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z0s1-1010_adam/10k'
        ...
        emb_dir = 'logs/emb/exp_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z0s1-1010_adam/100/100k_full'
        eval(use_gpu=True, emb_dir=emb_dir, n_sample_test=2000, mode='ivfpq-rr',
             n_probe = 20, display_interval=10, test_mirex_query=False,
             scope=[3], transformer=m_fp) # 10k mirex test
        eval(use_gpu=True, emb_dir=emb_dir, n_sample_test=2000, mode='ivfpq-rr',
