...
CUDA_VISIBLE_DEVICES=4 python train_context_240_seq5_win1_ovrp025_zr_inmask_multi_loss_c1z0s0_lamb_tau005.py exp_context_240_seq5_win1_ovrp025_zr_inmask_multi_loss_c1z0s0_lamb_tau005
CUDA_VISIBLE_DEVICES=4 python train_context_240_seq5_win1_ovrp025_zr_inmask_multi_loss_c1z0s0_lamb_tau005.py exp_context_240_seq5_win1_ovrp025_zr_inmask_multi_loss_c1z0s0_lamb_tau005 '' mini-test-only
CUDA_VISIBLE_DEVICES=4 python train_context_240_seq5_win1_ovrp025_zr_inmask_multi_loss_c1z0s0_lamb_tau005.py exp_context_240_seq5_win1_ovrp025_zr_inmask_multi_loss_c1z0s0_lamb_tau005 '45' save-db-query 100k # 3:99.39
...
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 37.50  73.02  84.96  94.55  96.57  99.30  
mrank: 21.47  4.96  2.27  0.36  0.18  0.02  
-----------ArgMin f(x) mini-TEST-----------
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 53.89  81.36  89.97  97.49  98.81  99.79  
mrank: 11.20  2.12  0.67  0.03  0.01  0.00  
---------ArgMin l2(f(x)) mini-TEST---------
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 54.10  81.36  90.81  97.21  98.53  99.79  
mrank: 11.19  2.14  0.68  0.04  0.02  0.00 
