...
CUDA_VISIBLE_DEVICES=6 OMP_NUM_THREADS=12 python final_train_with_EATS_v2fix_batch_NTxent_simCLR_seq256win1_specaug1_sp-1010db_lamb_tr100k.py final_exp_simCLR_seq256win1_specaug1_sp-1010db_lamb_tr100k
CUDA_VISIBLE_DEVICES=6 OMP_NUM_THREADS=12 python final_train_with_EATS_v2fix_batch_NTxent_simCLR_seq256win1_specaug1_sp-1010db_lamb_tr100k.py final_exp_simCLR_seq256win1_specaug1_sp-1010db_lamb_tr100k '1' mini-test-only
CUDA_VISIBLE_DEVICES=6 OMP_NUM_THREADS=12 python final_train_with_EATS_v2fix_batch_NTxent_simCLR_seq256win1_specaug1_sp-1010db_lamb_tr100k.py final_exp_simCLR_seq256win1_specaug1_sp-1010db_lamb_tr100k '100' save-db-query 100k_full # 3:99.39
CUDA_VISIBLE_DEVICES=6 OMP_NUM_THREADS=12 python eval_faiss.py cpu logs/emb/final_exp_simCLR_seq256win1_specaug1_sp-1010db_lamb_tr100k/100/10k 2000 ivfpq-rr 20

task=10kMIREX, use_gpu=True, mode=ivfpq-rr, n_probe20, n_test993
elapse time per 10 iterations: 0.2696 sec.
992/993
matched_exact=[ 4.13  8.36  9.77 11.48 12.08 12.79]%, scope=[1, 3, 5, 9, 11, 19]
matched_near=[19.23 32.33 37.66 44.81 46.93 50.55]%, scope=[1, 3, 5, 9, 11, 19]
matched_song=[19.23 32.33 37.66 44.81 46.93 50.55]%, scope=[1, 3, 5, 9, 11, 19]

task=10k, use_gpu=True, mode=ivfpq-rr, n_probe20, n_test2000
elapse time per 10 iterations: 0.3124 sec.
1999/2000
matched_exact=[68.55 91.05 95.75 97.5  97.8  98.85]%, scope=[1, 3, 5, 9, 11, 19]
matched_near=[69.65 91.15 95.75 97.5  97.8  98.85]%, scope=[1, 3, 5, 9, 11, 19]
matched_song=[69.65 91.15 95.75 97.5  97.8  98.85]%, scope=[1, 3, 5, 9, 11, 19]

task=100k_full, use_gpu=True, mode=ivfpq-rr, n_probe20, n_test2000
elapse time per 10 iterations: 1.3827 sec.
1999/2000
matched_exact=[43.8  71.65 78.75 84.35 85.45 87.9 ]%, scope=[1, 3, 5, 9, 11, 19]
matched_near=[44.1  71.7  78.8  84.35 85.5  87.9 ]%, scope=[1, 3, 5, 9, 11, 19]
matched_song=[44.1  71.7  78.8  84.35 85.5  87.9 ]%, scope=[1, 3, 5, 9, 11, 19]
...
WEIGHT_MULTI_LOSS = [0., 1.] # [context_loss, simclr_loss]
...
def generate_emb_mirex():
    ...
    print('Succesfully finshed generating embeddings for MIREX DB and Queries...\n')
    return
