...
CUDA_VISIBLE_DEVICES=6 python final_train_with_EATS_v2fix_batch_NTxent_simCLR_1280win1_specaug1_sp-1505db.py final_exp_NTxent_simCLR_1280win1_specaug1_sp-1505db
CUDA_VISIBLE_DEVICES=6 python final_train_with_EATS_v2fix_batch_NTxent_simCLR_1280win1_specaug1_sp-1505db.py final_exp_NTxent_simCLR_1280win1_specaug1_sp-1505db '1' mini-test-only
CUDA_VISIBLE_DEVICES=6 python final_train_with_EATS_v2fix_batch_NTxent_simCLR_1280win1_specaug1_sp-1505db.py final_exp_NTxent_simCLR_1280win1_specaug1_sp-1505db '100' save-db-query 100k_full # 3:99.39
CUDA_VISIBLE_DEVICES=0 python eval_faiss.py gpu logs/emb/final_exp_NTxent_simCLR_1280win1_specaug1_sp-1505db/100/10k 2000 ivfpq-rr 20 mirex
matched_exact=[ 8.95 13.76 16.21 18.38 19.32 21.58]%, scope=[1, 3, 5, 9, 11, 19]
matched_near=[33.84 49.95 59.47 72.76 76.34 82.75]%, scope=[1, 3, 5, 9, 11, 19]
matched_song=[37.04 52.12 61.36 74.27 77.66 83.98]%, scope=[1, 3, 5, 9, 11, 19]

CUDA_VISIBLE_DEVICES=0 python eval_faiss.py gpu logs/emb/final_exp_NTxent_simCLR_1280win1_specaug1_sp-1505db/100/10k 2000 ivfpq-rr 20
matched_exact=[74.69 94.02 95.98 97.94 98.54 99.5 ]%, scope=[1, 3, 5, 9, 11, 19]
matched_near=[79.46 94.42 96.18 97.99 98.59 99.5 ]%, scope=[1, 3, 5, 9, 11, 19]
matched_song=[86.59 96.63 97.74 98.74 99.05 99.6 ]%, scope=[1, 3, 5, 9, 11, 19]

CUDA_VISIBLE_DEVICES=0 OMP_NUM_THREADS=12 python eval_faiss.py gpu logs/emb/final_exp_NTxent_simCLR_1280win1_specaug1_sp-1505db/100/100k_full 2000 ivfpq-rr 20
matched_exact=[50.43 75.34 82.37 87.24 89.3  93.32]%, scope=[1, 3, 5, 9, 11, 19]
matched_near=[52.99 75.74 82.72 87.44 89.6  93.42]%, scope=[1, 3, 5, 9, 11, 19]
matched_song=[64.74 81.97 86.59 90.61 92.21 94.88]%, scope=[1, 3, 5, 9, 11, 19]
