...
CUDA_VISIBLE_DEVICES=0 python train_context_60_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z1s0.py exp_context_60_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z1s0
CUDA_VISIBLE_DEVICES=4 python train_context_60_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z1s0.py exp_context_60_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z1s0 '' mini-test-only
CUDA_VISIBLE_DEVICES=0 python train_context_60_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z1s0.py exp_context_60_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z1s0 '99' save-db-query 10k # 3:99.39
...
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 12.29  16.83  21.73  29.33  32.87  46.77  
mrank: 357.61  273.95  247.09  223.32  215.98  192.66  
-----------ArgMin f(x) mini-TEST-----------
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 16.32  22.74  28.48  34.71  38.60  46.48  
mrank: 333.20  270.80  252.04  233.68  228.02  209.91  
---------ArgMin l2(f(x)) mini-TEST---------
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 16.32  22.74  28.48  34.71  38.60  46.48  
mrank: 333.21  270.80  252.04  233.69  228.02  209.91  
