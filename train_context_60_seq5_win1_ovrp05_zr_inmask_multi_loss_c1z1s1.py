...
CUDA_VISIBLE_DEVICES=0 python train_context_60_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z1s1.py exp_context_60_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z1s1
CUDA_VISIBLE_DEVICES=0 python train_context_60_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z1s1.py exp_context_60_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z1s1 '' mini-test-only
...
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 72.43  91.31  95.68  98.18  98.60  100.00  
mrank: 5.49  0.51  0.08  0.02  0.01  0.00  
-----------ArgMin f(x) mini-TEST-----------
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 78.68  93.18  96.94  99.02  99.30  100.00  
mrank: 3.00  0.34  0.04  0.01  0.01  0.00  
---------ArgMin l2(f(x)) mini-TEST---------
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 78.75  93.12  96.94  99.02  99.30  100.00  
mrank: 3.00  0.35  0.04  0.01  0.01  0.00 
