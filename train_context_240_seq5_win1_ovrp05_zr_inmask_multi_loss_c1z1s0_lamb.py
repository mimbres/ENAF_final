...
CUDA_VISIBLE_DEVICES=3 python train_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z1s0_lamb.py exp_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z1s0_lamb
CUDA_VISIBLE_DEVICES=4 python train_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z1s0_lamb.py exp_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z1s0_lamb '' mini-test-only
CUDA_VISIBLE_DEVICES=4 python train_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z1s0_lamb.py exp_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z1s0_lamb '45' save-db-query 100k # 3:99.39
...
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 28.40  67.25  82.31  92.18  94.41  98.10  
mrank: 40.41  6.70  2.73  0.79  0.47  0.13  
-----------ArgMin f(x) mini-TEST-----------
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 39.03  76.01  86.28  93.78  95.17  98.24  
mrank: 14.09  1.17  0.36  0.11  0.07  0.02  
---------ArgMin l2(f(x)) mini-TEST---------
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 46.39  81.50  89.48  94.62  95.87  98.52  
mrank: 8.51  0.80  0.26  0.08  0.05  0.02
