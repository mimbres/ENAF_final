...
CUDA_VISIBLE_DEVICES=4 python train_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c0z0s1.py exp_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c0z0s1
CUDA_VISIBLE_DEVICES=4 python train_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c0z0s1.py exp_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c0z0s1 '' mini-test-only
CUDA_VISIBLE_DEVICES=4 python train_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c0z0s1.py exp_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c0z0s1 '45' save-db-query 100k # 3:99.39
...
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 80.90  95.13  97.70  99.30  99.51  100.00
mrank: 2.92  0.20  0.04  0.01  0.00  0.00
-----------ArgMin f(x) mini-TEST-----------
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 84.58  96.18  97.84  99.30  99.51  100.00
mrank: 1.77  0.11  0.03  0.01  0.00  0.00
---------ArgMin l2(f(x)) mini-TEST---------
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 84.65  96.24  97.84  99.30  99.51  100.00
mrank: 1.74  0.10  0.03  0.01  0.00  0.00
