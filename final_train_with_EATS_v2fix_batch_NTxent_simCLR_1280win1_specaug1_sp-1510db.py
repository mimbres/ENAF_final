...
CUDA_VISIBLE_DEVICES=1 python final_train_with_EATS_v2fix_batch_NTxent_simCLR_1280win1_specaug1_sp-1510db.py final_exp_NTxent_simCLR_1280win1_specaug1_sp-1510db
CUDA_VISIBLE_DEVICES=1 python final_train_with_EATS_v2fix_batch_NTxent_simCLR_1280win1_specaug1_sp-1510db.py final_exp_NTxent_simCLR_1280win1_specaug1_sp-1510db '1' mini-test-only
CUDA_VISIBLE_DEVICES=1 python final_train_with_EATS_v2fix_batch_NTxent_simCLR_1280win1_specaug1_sp-1510db.py final_exp_NTxent_simCLR_1280win1_specaug1_sp-1510db '100' save-db-query 100k_full # 3:99.39
CUDA_VISIBLE_DEVICES=1 OMP_NUM_THREADS=12 python eval_faiss.py gpu logs/emb/final_exp_NTxent_simCLR_1280win1_specaug1_sp-1510db/10k 2000 ivfpq-rr 20 mirex
mirex canceled
matched_exact=[ 8.01 14.23 16.49 18.85 19.04 21.3 ]%, scope=[1, 3, 5, 9, 11, 19]
matched_near=[31.1  49.58 59.19 72.86 76.63 83.13]%, scope=[1, 3, 5, 9, 11, 19]
matched_song=[32.99 51.46 61.17 74.18 78.13 84.45]%, scope=[1, 3, 5, 9, 11, 19]

mirex again
task=10kMIREX, use_gpu=True, mode=ivfpq-rr, n_probe20, n_test1061
elapse time per 10 iterations: 0.2831 sec.
1060/1061
matched_exact=[ 8.01 14.23 16.49 18.85 19.04 21.3 ]%, scope=[1, 3, 5, 9, 11, 19]
matched_near=[31.1  49.58 59.19 72.86 76.63 83.13]%, scope=[1, 3, 5, 9, 11, 19]
matched_song=[31.1  49.58 59.19 72.86 76.63 83.13]%, scope=[1, 3, 5, 9, 11, 19]



CUDA_VISIBLE_DEVICES=1 OMP_NUM_THREADS=12 python eval_faiss.py gpu logs/emb/final_exp_NTxent_simCLR_1280win1_specaug1_sp-1510db/100/100k_full 2000 ivfpq-rr 20
matched_exact=[52.64 76.85 82.77 88.55 89.95 94.17]%, scope=[1, 3, 5, 9, 11, 19]
matched_near=[55.05 77.45 82.97 88.8  90.26 94.37]%, scope=[1, 3, 5, 9, 11, 19]
matched_song=[67.15 83.32 87.64 92.11 93.12 95.73]%, scope=[1, 3, 5, 9, 11, 19]
