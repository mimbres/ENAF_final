...
CUDA_VISIBLE_DEVICES=5 OMP_NUM_THREADS=12 python final_train_with_EATS_v2fix_batch_NTxent_simCLR_seq256win1_specaug1_sp-1010db_adam.py final_exp_simCLR_seq256win1_specaug1_sp-1010db_adam
CUDA_VISIBLE_DEVICES=5 OMP_NUM_THREADS=12 python final_train_with_EATS_v2fix_batch_NTxent_simCLR_seq256win1_specaug1_sp-1010db_adam.py final_exp_simCLR_seq256win1_specaug1_sp-1010db_adam '1' mini-test-only
CUDA_VISIBLE_DEVICES=5 OMP_NUM_THREADS=12 python final_train_with_EATS_v2fix_batch_NTxent_simCLR_seq256win1_specaug1_sp-1010db_adam.py final_exp_simCLR_seq256win1_specaug1_sp-1010db_adam '100' save-db-query 100k_full # 3:99.39
CUDA_VISIBLE_DEVICES=5 OMP_NUM_THREADS=12 python eval_faiss.py cpu logs/emb/final_exp_simCLR_seq256win1_specaug1_sp-1010db_adam/100/10k 2000 ivfpq-rr 20

task=10kMIREX, use_gpu=True, mode=ivfpq-rr, n_probe20, n_test993
elapse time per 10 iterations: 0.2617 sec.
992/993
matched_exact=[ 6.45 12.19 14.6  15.61 16.21 17.93]%, scope=[1, 3, 5, 9, 11, 19]
matched_near=[22.86 41.39 49.95 58.51 60.52 66.57]%, scope=[1, 3, 5, 9, 11, 19]
matched_song=[22.86 41.39 49.95 58.51 60.52 66.57]%, scope=[1, 3, 5, 9, 11, 19]

task=10k, use_gpu=True, mode=ivfpq-rr, n_probe20, n_test2000
elapse time per 10 iterations: 0.3022 sec.
1999/2000
matched_exact=[69.   92.85 96.5  98.4  98.8  99.25]%, scope=[1, 3, 5, 9, 11, 19]
matched_near=[69.8  92.9  96.55 98.4  98.8  99.25]%, scope=[1, 3, 5, 9, 11, 19]
matched_song=[69.8  92.9  96.55 98.4  98.8  99.25]%, scope=[1, 3, 5, 9, 11, 19]

task=100k_full, use_gpu=True, mode=ivfpq-rr, n_probe20, n_test2000
elapse time per 10 iterations: 1.3331 sec.
1999/2000
matched_exact=[41.25 71.   79.75 85.15 86.7  90.15]%, scope=[1, 3, 5, 9, 11, 19]
matched_near=[41.45 71.05 79.75 85.2  86.7  90.15]%, scope=[1, 3, 5, 9, 11, 19]
matched_song=[41.45 71.05 79.75 85.2  86.7  90.15]%, scope=[1, 3, 5, 9, 11, 19]
