...
class MomentumLARS(tf.keras.optimizers.Optimizer):
    ...
    Learning rate in SimCLR: 0.3*(bsz/256) with weight decay=10e-6
    """
    ...
    def compute_lr(self, grad, var, apply_state):
    ...
    def _apply_dense(self, grad, var, apply_state=None):
        scaled_lr, grad = self.compute_lr(grad, var, apply_state)
