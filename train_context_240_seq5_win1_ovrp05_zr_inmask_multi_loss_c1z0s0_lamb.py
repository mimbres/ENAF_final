...
CUDA_VISIBLE_DEVICES=2 python train_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z0s0_lamb.py exp_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z0s0_lamb
CUDA_VISIBLE_DEVICES=2 python train_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z0s0_lamb.py exp_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z0s0_lamb '' mini-test-only
CUDA_VISIBLE_DEVICES=1 python train_context_60_seq5_win1_ovrp05_zr_inmask_multi_loss.py exp_context_60_seq5_win1_ovrp05_zr_inmask_multi_loss '45' save-db-query 100k # 3:99.39
...
ep44
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 51.04  82.89  89.62  95.18  96.08  99.02  
mrank: 14.10  3.33  1.56  0.46  0.15  0.01  
-----------ArgMin f(x) mini-TEST-----------
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 65.07  87.20  92.20  96.09  96.92  99.30  
mrank: 5.66  0.94  0.33  0.09  0.05  0.01  
---------ArgMin l2(f(x)) mini-TEST---------
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 65.97  87.90  92.90  96.30  97.48  99.44  
mrank: 5.18  0.87  0.30  0.06  0.03  0.01  
