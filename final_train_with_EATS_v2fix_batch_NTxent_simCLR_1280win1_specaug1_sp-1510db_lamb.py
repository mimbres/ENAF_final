...
CUDA_VISIBLE_DEVICES=3 OMP_NUM_THREADS=12 python final_train_with_EATS_v2fix_batch_NTxent_simCLR_1280win1_specaug1_sp-1510db_lamb.py final_exp_NTxent_simCLR_1280win1_specaug1_sp-1510db_lamb
CUDA_VISIBLE_DEVICES=3 OMP_NUM_THREADS=12 python final_train_with_EATS_v2fix_batch_NTxent_simCLR_1280win1_specaug1_sp-1510db_lamb.py final_exp_NTxent_simCLR_1280win1_specaug1_sp-1510db_lamb '1' mini-test-only
CUDA_VISIBLE_DEVICES=3 OMP_NUM_THREADS=12 python final_train_with_EATS_v2fix_batch_NTxent_simCLR_1280win1_specaug1_sp-1510db_lamb.py final_exp_NTxent_simCLR_1280win1_specaug1_sp-1510db_lamb '100' save-db-query 100k_full 
CUDA_VISIBLE_DEVICES=3 OMP_NUM_THREADS=12 python eval_faiss.py gpu logs/emb/final_exp_NTxent_simCLR_1280win1_specaug1_sp-1510db_lamb/100/10k 2000 ivfpq-rr 20 mirex
task=10kMIREX, use_gpu=True, mode=ivfpq-rr, n_probe20, n_test1061
elapse time per 10 iterations: 0.3050 sec.
1060/1061
matched_exact=[ 9.52 14.51 17.25 19.23 19.32 21.11]%, scope=[1, 3, 5, 9, 11, 19]
matched_near=[37.13 51.93 63.62 75.59 78.79 84.17]%, scope=[1, 3, 5, 9, 11, 19]
matched_song=[37.13 51.93 63.62 75.59 78.79 84.17]%, scope=[1, 3, 5, 9, 11, 19]

task=10k, use_gpu=True, mode=ivfpq-rr, n_probe20, n_test2000
elapse time per 10 iterations: 0.2578 sec.
1999/2000
matched_exact=[85.05 95.85 97.7  98.8  99.05 99.65]%, scope=[1, 3, 5, 9, 11, 19]
matched_near=[88.   96.05 97.7  98.85 99.15 99.65]%, scope=[1, 3, 5, 9, 11, 19]
matched_song=[88.   96.05 97.7  98.85 99.15 99.65]%, scope=[1, 3, 5, 9, 11, 19]

task=100k_full, use_gpu=True, mode=ivfpq-rr, n_probe20, n_test2000
elapse time per 10 iterations: 1.0559 sec.
1999/2000
matched_exact=[62.8  82.55 87.85 92.35 93.25 95.55]%, scope=[1, 3, 5, 9, 11, 19]
matched_near=[65.3  83.   88.   92.35 93.25 95.65]%, scope=[1, 3, 5, 9, 11, 19]
matched_song=[65.3  83.   88.   92.35 93.25 95.65]%, scope=[1, 3, 5, 9, 11, 19]
...
def get_train_ds():
    ds = generator_fp.genUnbalSequence(
        ...
        speech_mix_parameter=[True, speech_tr_fps, (-15,10)])
    return ds
