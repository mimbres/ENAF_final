...
CUDA_VISIBLE_DEVICES=0 python train_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c0z0s1_lamb.py exp_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c0z0s1_lamb
CUDA_VISIBLE_DEVICES=4 python train_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c0z0s1_lamb.py exp_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c0z0s1_lamb '' mini-test-only
CUDA_VISIBLE_DEVICES=4 python train_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c0z0s1_lamb.py exp_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c0z0s1_lamb '45' save-db-query 100k # 3:99.39
...
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 79.44  93.95  96.87  98.74  99.30  100.00  
mrank: 4.81  0.26  0.05  0.01  0.01  0.00  
-----------ArgMin f(x) mini-TEST-----------
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 84.17  94.71  97.08  99.02  99.58  100.00  
mrank: 3.73  0.32  0.04  0.01  0.00  0.00  
---------ArgMin l2(f(x)) mini-TEST---------
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 84.17  94.78  97.08  99.02  99.51  100.00  
mrank: 3.87  0.35  0.05  0.01  0.00  0.00 
