...
CUDA_VISIBLE_DEVICES=2 python train_context_240_seq5_win1_ovrp025_zr_inmask_multi_loss_c1z0s0_lamb_tau02.py exp_context_240_seq5_win1_ovrp025_zr_inmask_multi_loss_c1z0s0_lamb_tau02
CUDA_VISIBLE_DEVICES=4 python train_context_240_seq5_win1_ovrp025_zr_inmask_multi_loss_c1z0s0_lamb_tau02.py exp_context_240_seq5_win1_ovrp025_zr_inmask_multi_loss_c1z0s0_lamb_tau02 '' mini-test-only
CUDA_VISIBLE_DEVICES=1 python train_context_240_seq5_win1_ovrp025_zr_inmask_multi_loss_c1z0s0_lamb_tau02.py exp_context_240_seq5_win1_ovrp025_zr_inmask_multi_loss_c1z0s0_lamb_tau02 '45' save-db-query 100k # 3:99.39
...
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 8.61  16.90  27.65  47.21  56.22  79.96  
mrank: 150.53  73.49  44.31  20.34  14.78  4.46  
-----------ArgMin f(x) mini-TEST-----------
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 8.47  13.91  19.78  31.84  36.50  53.59  
mrank: 277.12  185.38  141.98  104.53  92.06  60.64  
---------ArgMin l2(f(x)) mini-TEST---------
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 9.65  22.32  34.47  54.61  63.71  81.93  
mrank: 148.62  72.02  42.53  18.77  13.62  4.22  
...
SEQ_SCOPE_N_SEG = 5
B_SEG_IN_SEQ = 5
SEQ_SAMPLING_HOP = 0.768
SEQ_SAMPLING_OFFSET_HOP_RATE = 0.4 # rand. offset +-(hop/2)
SEG_WIN = 1.024 # sec
SEG_HOP = 0.768 #0.512 # sec
SEQ_SCOPE_SEC = SEG_HOP * B_SEG_IN_SEQ + (SEG_WIN - SEG_HOP) #4.096#4.608 # sec
SEQ_SAMPLING_DUR = SEQ_SCOPE_SEC # 4.096#4.608#10.
