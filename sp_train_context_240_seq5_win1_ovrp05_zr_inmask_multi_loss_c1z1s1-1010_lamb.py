...
CUDA_VISIBLE_DEVICES=7 python sp_train_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z1s1-1010_lamb.py exp_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z1s1-1010_lamb
CUDA_VISIBLE_DEVICES=4 python sp_train_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z1s1-1010_lamb.py exp_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z1s1-1010_lamb '' mini-test-only
CUDA_VISIBLE_DEVICES=7 python sp_train_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z1s1-1010_lamb.py exp_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z1s1-1010_lamb '100' save-db-query 100k_full 
CUDA_VISIBLE_DEVICES=6 OMP_NUM_THREADS=12 python eval_faiss.py gpu logs/emb/exp_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z1s1-1010_lamb/100/100k_full 2000 ivfpq-rr 20

---------ArgMin g(f(x)) mini-TEST----------
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 82.22  94.99  97.01  97.97  98.60  99.79
mrank: 1.99  0.10  0.05  0.02  0.01  0.00
-----------ArgMin f(x) mini-TEST-----------
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 78.54  92.70  94.99  96.72  97.76  98.87
mrank: 9.65  3.92  1.89  0.38  0.07  0.02
---------ArgMin l2(f(x)) mini-TEST---------
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 78.26  92.56  95.13  96.86  97.62  98.87
mrank: 9.11  3.55  1.45  0.22  0.04  0.02

mirex
matched_exact=[ 5.35 11.3  13.22 14.93 15.54 17.86]%, scope=[1, 3, 5, 9, 11, 19]
matched_near=[20.48 37.74 45.11 54.79 57.72 64.68]%, scope=[1, 3, 5, 9, 11, 19]
matched_song=[21.49 39.96 47.53 56.   59.03 65.49]%, scope=[1, 3, 5, 9, 11, 19]

10k
matched_exact=[61.18 88.95 95.03 97.74 98.19 98.9 ]%, scope=[1, 3, 5, 9, 11, 19]
matched_near=[62.13 89.05 95.08 97.74 98.19 98.9 ]%, scope=[1, 3, 5, 9, 11, 19]
matched_song=[69.46 92.27 96.43 98.34 98.44 98.95]%, scope=[1, 3, 5, 9, 11, 19]

100k_full
matched_exact=[36.46 66.5  74.28 82.32 83.73 87.34]%, scope=[1, 3, 5, 9, 11, 19]
matched_near=[36.92 66.6  74.28 82.32 83.73 87.34]%, scope=[1, 3, 5, 9, 11, 19]
matched_song=[47.31 73.03 79.81 84.83 86.39 88.65]%, scope=[1, 3, 5, 9, 11, 19]

--Search with transformer--
CUDA_VISIBLE_DEVICES=3 OMP_NUM_THREADS=12 python sp_train_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z1s1-1010_lamb.py exp_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z1s1-1010_lamb '100' test_sc3
...
def main():
    if TEST_MODE == 'mini-test-only':
        ...
        m_fp.trainable = False
        emb_dir = 'logs/emb/exp_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z1s1-1010_lamb/100/10k'
        ...
        emb_dir = 'logs/emb/exp_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z1s1-1010_lamb/100/100k_full'
        eval(use_gpu=True, emb_dir=emb_dir, n_sample_test=2000, mode='ivfpq-rr',
             n_probe = 20, display_interval=10, test_mirex_query=False,
             scope=[3], transformer=m_fp) # 10k mirex test
        eval(use_gpu=True, emb_dir=emb_dir, n_sample_test=2000, mode='ivfpq-rr',
