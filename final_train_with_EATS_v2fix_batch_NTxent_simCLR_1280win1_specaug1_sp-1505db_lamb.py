...
CUDA_VISIBLE_DEVICES=2 OMP_NUM_THREADS=12 python final_train_with_EATS_v2fix_batch_NTxent_simCLR_1280win1_specaug1_sp-1505db_lamb.py final_exp_NTxent_simCLR_1280win1_specaug1_sp-1505db_lamb
CUDA_VISIBLE_DEVICES=2 OMP_NUM_THREADS=12 python final_train_with_EATS_v2fix_batch_NTxent_simCLR_1280win1_specaug1_sp-1505db_lamb.py final_exp_NTxent_simCLR_1280win1_specaug1_sp-1505db_lamb '1' mini-test-only
CUDA_VISIBLE_DEVICES=2 OMP_NUM_THREADS=12 python final_train_with_EATS_v2fix_batch_NTxent_simCLR_1280win1_specaug1_sp-1505db_lamb.py final_exp_NTxent_simCLR_1280win1_specaug1_sp-1505db_lamb '100' save-db-query 100k_full 
CUDA_VISIBLE_DEVICES=2 OMP_NUM_THREADS=12 python eval_faiss.py gpu logs/emb/final_exp_NTxent_simCLR_1280win1_specaug1_sp-1505db_lamb/100/10k 2000 ivfpq-rr 20 mirex
task=10kMIREX, use_gpu=True, mode=ivfpq-rr, n_probe20, n_test1061
elapse time per 10 iterations: 0.3377 sec.
1060/1061
matched_exact=[ 9.24 14.89 17.15 19.51 19.32 21.02]%, scope=[1, 3, 5, 9, 11, 19]
matched_near=[36.85 54.01 63.81 76.15 78.04 83.69]%, scope=[1, 3, 5, 9, 11, 19]
matched_song=[36.85 54.01 63.81 76.15 78.04 83.69]%, scope=[1, 3, 5, 9, 11, 19]

task=10k, use_gpu=True, mode=ivfpq-rr, n_probe20, n_test2000
elapse time per 10 iterations: 0.2411 sec.
1999/2000
matched_exact=[83.65 95.95 97.55 98.75 99.2  99.7 ]%, scope=[1, 3, 5, 9, 11, 19]
matched_near=[87.6  96.15 97.7  98.8  99.25 99.75]%, scope=[1, 3, 5, 9, 11, 19]
matched_song=[87.6  96.15 97.7  98.8  99.25 99.75]%, scope=[1, 3, 5, 9, 11, 19]

task=100k_full, use_gpu=True, mode=ivfpq-rr, n_probe20, n_test2000
elapse time per 10 iterations: 1.0180 sec.
1999/2000
matched_exact=[61.4  82.2  87.05 92.   92.9  95.35]%, scope=[1, 3, 5, 9, 11, 19]
matched_near=[63.5 82.5 87.2 92.1 93.  95.4]%, scope=[1, 3, 5, 9, 11, 19]
matched_song=[63.5 82.5 87.2 92.1 93.  95.4]%, scope=[1, 3, 5, 9, 11, 19]
...
def get_train_ds():
    ds = generator_fp.genUnbalSequence(
        ...
        speech_mix_parameter=[True, speech_tr_fps, (-15,5)])
    return ds
