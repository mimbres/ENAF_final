...
CUDA_VISIBLE_DEVICES=3 python train_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z0s0.py exp_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z0s0
CUDA_VISIBLE_DEVICES=0 python train_context_60_seq5_win1_ovrp05_zr_inmask_multi_loss.py exp_context_60_seq5_win1_ovrp05_zr_inmask_multi_loss '1' mini-test-only
...
ep61
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 0.21  0.21  0.14  0.14  0.07  0.07  
mrank: 714.50  712.28  706.45  696.29  691.69  677.27  
-----------ArgMin f(x) mini-TEST-----------
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 0.14  0.21  0.14  0.21  0.28  0.28  
mrank: 711.68  707.06  698.12  682.05  674.88  654.22  
---------ArgMin l2(f(x)) mini-TEST---------
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 0.14  0.21  0.14  0.14  0.21  0.14  
mrank: 712.30  706.52  698.59  683.47  676.55  656.14  
