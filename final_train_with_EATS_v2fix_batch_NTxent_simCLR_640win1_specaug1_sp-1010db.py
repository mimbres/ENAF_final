...
CUDA_VISIBLE_DEVICES=4 python final_train_with_EATS_v2fix_batch_NTxent_simCLR_640win1_specaug1_sp-1010db.py final_exp_NTxent_simCLR_640win1_specaug1_sp-1010db
CUDA_VISIBLE_DEVICES=4 python final_train_with_EATS_v2fix_batch_NTxent_simCLR_640win1_specaug1_sp-1010db.py final_exp_NTxent_simCLR_640win1_specaug1_sp-1010db '1' mini-test-only
CUDA_VISIBLE_DEVICES=4 python final_train_with_EATS_v2fix_batch_NTxent_simCLR_640win1_specaug1_sp-1010db.py final_exp_NTxent_simCLR_640win1_specaug1_sp-1010db '100' save-db-query 100k_full 
CUDA_VISIBLE_DEVICES=4 python eval_faiss.py gpu logs/emb/final_exp_NTxent_simCLR_640win1_specaug1_sp-1010db/100/10k 2000 ivfpq-rr 20 mirex
matched_exact=[ 8.86 14.14 16.59 19.42 19.7  21.3 ]%, scope=[1, 3, 5, 9, 11, 19]
matched_near=[32.99 49.86 60.13 73.33 76.44 82.09]%, scope=[1, 3, 5, 9, 11, 19]
matched_song=[35.16 51.93 61.92 74.55 77.85 83.13]%, scope=[1, 3, 5, 9, 11, 19]

10k
matched_exact=[81.17 95.58 97.69 98.84 99.3  99.65]%, scope=[1, 3, 5, 9, 11, 19]
matched_near=[85.59 95.83 97.74 98.95 99.35 99.65]%, scope=[1, 3, 5, 9, 11, 19]
matched_song=[91.61 97.99 99.05 99.35 99.5  99.75]%, scope=[1, 3, 5, 9, 11, 19]
