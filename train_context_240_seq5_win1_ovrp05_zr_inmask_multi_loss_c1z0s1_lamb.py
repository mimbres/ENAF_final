...
CUDA_VISIBLE_DEVICES=4 python train_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z0s1_lamb.py exp_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z0s1_lamb
CUDA_VISIBLE_DEVICES=4 python train_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z0s1_lamb.py exp_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z0s1_lamb '' mini-test-only
CUDA_VISIBLE_DEVICES=4 python train_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z0s1_lamb.py exp_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z0s1_lamb '45' save-db-query 100k_full  # 3:99.39
---------ArgMin g(f(x)) mini-TEST----------
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 74.44  91.17  94.36  96.72  97.76  99.51  
mrank: 5.79  2.04  0.91  0.15  0.02  0.00  
-----------ArgMin f(x) mini-TEST-----------
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 78.26  92.77  95.13  97.42  98.25  99.30  
mrank: 4.54  1.35  0.42  0.04  0.02  0.01  
---------ArgMin l2(f(x)) mini-TEST---------
scope:   [1, 3, 5, 9, 11, 19]
T1acc: 78.33  92.77  95.19  97.42  98.25  99.30  
mrank: 4.59  1.52  0.47  0.05  0.02  0.01  

CUDA_VISIBLE_DEVICES=5 OMP_NUM_THREADS=12 python eval_faiss.py gpu logs/emb/exp_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z0s1_lamb/45/10k 2000 ivfpq-rr 20
matched_exact=[70.37 91.81 95.53 97.49 98.14 98.9 ]%, scope=[1, 3, 5, 9, 11, 19]
matched_near=[71.22 91.96 95.68 97.49 98.14 98.9 ]%, scope=[1, 3, 5, 9, 11, 19]
matched_song=[79.21 94.68 97.24 98.29 98.59 99.25]%, scope=[1, 3, 5, 9, 11, 19]

CUDA_VISIBLE_DEVICES=2 OMP_NUM_THREADS=12 python eval_faiss.py gpu logs/emb/exp_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z0s1_lamb/45/10k 2000 ivfpq-rr 20 mirex
matched_exact=[ 4.34  7.16  8.38 10.6  11.   12.51]%, scope=[1, 3, 5, 9, 11, 19]
matched_near=[18.06 27.04 32.69 41.78 44.8  49.85]%, scope=[1, 3, 5, 9, 11, 19]
matched_song=[21.7  30.68 35.12 43.29 45.71 50.66]%, scope=[1, 3, 5, 9, 11, 19]

CUDA_VISIBLE_DEVICES=2 OMP_NUM_THREADS=12 python eval_faiss.py gpu logs/emb/exp_context_240_seq5_win1_ovrp05_zr_inmask_multi_loss_c1z0s1_lamb/45/100k_full 2000 ivfpq-rr 20 
matched_exact=[41.49 68.36 76.24 82.62 84.33 88.1 ]%, scope=[1, 3, 5, 9, 11, 19]
matched_near=[41.84 68.41 76.24 82.67 84.38 88.1 ]%, scope=[1, 3, 5, 9, 11, 19]
matched_song=[51.53 74.38 81.12 85.23 86.69 89.8 ]%, scope=[1, 3, 5, 9, 11, 19]
...
def get_train_ds():
    ds = generator_fp.genUnbalSequence(
        ...
        speech_mix_parameter=[False]) #True, speech_tr_fps, (10,10)])
    return ds
