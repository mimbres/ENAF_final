...
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_NTxent_simCLR_640win1_server.py exp_NTxent_simCLR_320_ln_drop_lamb_sch1e03
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_NTxent_simCLR_640win1_server.py exp_NTxent_simCLR_use_anc_rep_320 '1' mini-test-only
CUDA_VISIBLE_DEVICES=1 python train_with_EATS_v2fix_batch_NTxent_simCLR_640win1_server.py exp_NTxent_simCLR_640_ln_drop_lamb_lr1e04 '59' save-db-query # 3:99.39
...
def get_train_ds():
    ds = generator_fp.genUnbalSequence(
        fns_event_list=music_fps[:-1000],#[:8500],
        bsz=TR_BATCH_SZ,
