...
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_NTxent_simCLR_640win1_server_d64_seen.py exp_NTxent_simCLR_640_d64_ln_drop_lamb_seen
CUDA_VISIBLE_DEVICES=0 python train_with_EATS_v2fix_batch_NTxent_simCLR_640win1_server_d64_seen.py exp_NTxent_simCLR_640_d64_ln_drop_lamb_seen '70' mini-test-only
CUDA_VISIBLE_DEVICES=1 python train_with_EATS_v2fix_batch_NTxent_simCLR_640win1_server_d64_seen.py exp_NTxent_simCLR_640_d64_ln_drop_lamb_seen '111' save-db-query 100k_full
...
def generate_emb(n_query=3000000):
    ...
    enq.start(workers=16, max_queue_size=28)
